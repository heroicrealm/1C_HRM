...
Процедура РаботаВМедицинскомУчрежденииПриИзменении(Элемент)
	...
	Если Не РаботаВМедицинскомУчреждении Тогда
		...
		ИспользоватьАккредитациюСпециалистов = Ложь;
	КонецЕсли;
	ОбновитьФормуПоНастройкам(ЭтаФорма);
...
Процедура ПолучитьНастройкиПрограммы()
	...
	ИспользоватьАккредитациюСпециалистов                    	 = НастройкиПрограммы.ИспользоватьАккредитациюСпециалистов;
...
Процедура ОбновитьФормуПоНастройкам(Форма)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		"ИспользоватьАккредитациюСпециалистов", "Доступность", Форма.РаботаВМедицинскомУчреждении);
...
Функция ЗаписатьНастройкиНаСервере()
	...
	ПараметрыНастроек.НастройкиМедицинскогоУчреждения.ИспользоватьАккредитациюСпециалистов = ИспользоватьАккредитациюСпециалистов;
