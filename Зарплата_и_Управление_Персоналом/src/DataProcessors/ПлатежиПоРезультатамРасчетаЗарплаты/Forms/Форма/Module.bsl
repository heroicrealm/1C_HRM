...
Функция ТаблицаНалогКУплате(ПоказыватьФинансирование)
	...
	ТаблицаНДФЛ.Свернуть(ПоляГруппировки, "Сумма");
...
Процедура ОбновитьНДФЛОбязательства()
	...
	НакопленныеОбязательства.Свернуть("Организация,РегистрацияВНалоговомОргане","Сумма");
	...
	ОбязательстваДетально.Свернуть("Дата,Организация,РегистрацияВНалоговомОргане","Сумма");
