...
Перем ОписаниеРассчитываемогоНабораНачислений;
...
Процедура УстановитьРассчитываемыйНаборНачислений(УстанавливаемыйМенеджреВременныхТаблицы, ОписаниеУстанавливаемогоНабораНачислений, УстанавливаемеыйМенеджерДанныхУчетаВремени = Неопределено, УстанавливаемыйМенеджерКадровогоУчета = Неопределено) Экспорт
	МенеджерВременныхТаблиц = УстанавливаемыйМенеджреВременныхТаблицы;
	ОписаниеРассчитываемогоНабораНачислений = ОписаниеУстанавливаемогоНабораНачислений;
...
Процедура УстановитьРассчитываемыйНаборУдержаний(УстанавливаемыйМенеджреВременныхТаблицы, ОписаниеУстанавливаемогоНабораУдержаний, УстанавливаемеыйМенеджерДанныхУчетаВремени = Неопределено, УстанавливаемыйМенеджерКадровогоУчета = Неопределено) Экспорт
	МенеджерВременныхТаблиц = УстанавливаемыйМенеджреВременныхТаблицы;
...
Процедура ИнициализироватьРасчетБазыНачислений() 
	Если Не ЗарплатаКадры.ВТСодержитСтроки(МенеджерВременныхТаблиц, ОписаниеРассчитываемогоНабораНачислений.ИмяВТРассчитываемыеЗаписи) Тогда
	...
	ОписаниеОтбора.ИмяВТОсновныеЗаписи = ОписаниеРассчитываемогоНабораНачислений.ИмяВТРассчитываемыеЗаписи;
	ОписаниеОтбора.ИмяТаблицыВедущиеВидыРасчета = ОписаниеРассчитываемогоНабораНачислений.ИмяТаблицыБазовыеЗаписи;
	...
	СоздатьВТБазовыеЗаписи(ОписаниеОтбора, ОписаниеВТБазовыеЗаписиРезультат, ОписаниеРассчитываемогоНабораНачислений.ОписаниеТекущегоНабораРегистраНачисления);
	...
	Если ОписаниеНеобходмыхДанных.НеобходимоПолучатьФПДБазовыхЗаписей 
		...
		СоздатьВТБазовыеЗаписиПериоды(ОписаниеНеобходмыхДанных,
			ОписаниеРассчитываемогоНабораНачислений.ОписаниеТекущегоНабораРегистраНачисления,
	...
	Если ОписаниеНеобходмыхДанных.НеобходимоНормироватьЗаписиКаскадно Тогда
		ДанныеКаскадногоНормирования = ДанныеКаскадногоНормирования(ИмяВТБазовыеЗаписиНачисленийПериоды, ОписаниеРассчитываемогоНабораНачислений.ОписаниеТекущегоНабораРегистраНачисления);	
	...
	Если ОписаниеНеобходмыхДанных.НеобходимоНормироватьЗаписи Тогда
		СоздатьВТКоэффициентыНормированияПоВремени(ИмяВТБазовыеЗаписиНачисленийПериоды, ВедущиеЗаписиДляКаскадногоНормирования, МенеджерДанныхУчетаВремени, "ВТКоэффициентыБазовыхЗаписейНачисленийПоВремени");
	Иначе
		СоздатьВТКоэффициентыНормированияПоВремениПустая("ВТКоэффициентыБазовыхЗаписейНачисленийПоВремени");
	КонецЕсли;	
	УдерживаеимыеТаблицыРасчетаНачислений.Добавить("ВТКоэффициентыБазовыхЗаписейНачисленийПоВремени");
		
	Запрос = Новый Запрос("ВЫБРАТЬ * ИЗ ВТКоэффициентыБазовыхЗаписейНачисленийПоВремени КАК БазовыеЗаписиКоэффициентыПоВремени ГДЕ БазовыеЗаписиКоэффициентыПоВремени.ВедущаяЗаписьКаскадногоРасчета");
...
Процедура ИнициализироватьРасчетУжержаний() 
	Если Не ЗарплатаКадры.ВТСодержитСтроки(МенеджерВременныхТаблиц, ОписаниеРасчитываемогоНабораУдержаний.ИмяВТРассчитываемыеЗаписи) Тогда
	...
	ОписаниеОтбора = ОписаниеОтбораВТБазовыеЗаписи();
	ОписаниеОтбора.ИмяВТОсновныеЗаписи = ОписаниеРасчитываемогоНабораУдержаний.ИмяВТРассчитываемыеЗаписи;
	...
	Если ОписаниеНеобходмыхДанных.НеобходимоНормироватьЗаписи Тогда
		СоздатьВТКоэффициентыНормированияПоВремени(ИмяВТБазовыеЗаписиУдержанийПериоды, ВедущиеЗаписиДляКаскадногоНормирования, МенеджерДанныхУчетаВремени, "ВТКоэффициентыБазовыхЗаписейУдержанийПоВремени");
	Иначе
		СоздатьВТКоэффициентыНормированияПоВремениПустая("ВТКоэффициентыБазовыхЗаписейУдержанийПоВремени");
	КонецЕсли;	
	УдерживаеимыеТаблицыРасчетаУдержаний.Добавить("ВТКоэффициентыБазовыхЗаписейУдержанийПоВремени");
			
	Запрос = Новый Запрос("ВЫБРАТЬ * ИЗ ВТКоэффициентыБазовыхЗаписейУдержанийПоВремени КАК БазовыеЗаписиКоэффициентыПоВремени ГДЕ БазовыеЗаписиКоэффициентыПоВремени.ВедущаяЗаписьКаскадногоРасчета");
	Запрос.МенеджерВременныхТаблиц = МенеджерВременныхТаблиц;
...
Процедура СоздатьВТРасчетнаяБазаНачислений(РезультатыРасчетаБазовыхНачислений = Неопределено, ОчередностьРасчета = Неопределено, ИмяВТРезультат = "ВТРасчетнаяБазаНачислений") Экспорт
	...
	|			ИНАЧЕ ВЫРАЗИТЬ(КоэффициентыБазовыхЗаписейНачисленийПоВремени.Коэффициент КАК ЧИСЛО(31, 8))
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТКоэффициентыБазовыхЗаписейНачисленийПоВремени КАК КоэффициентыБазовыхЗаписейНачисленийПоВремени
	|		ПО (БазовыеЗаписи.Регистратор = КоэффициентыБазовыхЗаписейНачисленийПоВремени.Регистратор)
	|			И (БазовыеЗаписи.НомерСтроки = КоэффициентыБазовыхЗаписейНачисленийПоВремени.НомерСтроки)
	|			И (БазовыеЗаписи.НеобходимоНормировать)
	|			И (НЕ БазовыеЗаписи.НормироватьКаскадно)
	|			И (НЕ КоэффициентыБазовыхЗаписейНачисленийПоВремени.ВедущаяЗаписьКаскадногоРасчета)
	|			И (КоэффициентыБазовыхЗаписейНачисленийПоВремени.БазовыйПериодОсновнойЗаписиНачало = БазовыеЗаписи.БазовыйПериодОсновнойЗаписиНачало)
	|			И (КоэффициентыБазовыхЗаписейНачисленийПоВремени.БазовыйПериодОсновнойЗаписиКонец = БазовыеЗаписи.БазовыйПериодОсновнойЗаписиКонец)
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВТОсновныеЗаписи", ОписаниеРассчитываемогоНабораНачислений.ИмяВТРассчитываемыеЗаписи);
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВТРасчетнаяБазаНачислений", ИмяВТРезультат);
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "ПланВидовРасчета.Начисления.БазовыеВидыРасчета", ОписаниеРассчитываемогоНабораНачислений.ИмяТаблицыБазовыеЗаписи);


	Если ОчередностьРасчета = Неопределено Тогда
		ТекстУсловияОчередностьРасчета = "ИСТИНА";
	Иначе
		ТекстУсловияОчередностьРасчета = "ОсновныеЗаписи." + ОписаниеРассчитываемогоНабораНачислений.ИмяПоляОчередностьРасчета + " = &ОчередностьРасчета";
...
Процедура СоздатьВТРасчетнаяБазаУдержаний(ОчередностьРасчета = Неопределено, ИмяВТРезультат = "ВТРасчетнаяБазаУдержаний") Экспорт
	...
	|				ТОГДА ВЫРАЗИТЬ(КоэффициентыКаскадноНормируемыхЗаписей.Коэффициент КАК ЧИСЛО(31, 8))
	|			КОГДА БазовыеЗаписи.НеобходимоНормировать
	|				ТОГДА ВЫРАЗИТЬ(КоэффициентыБазовыхЗаписейУдержанийПоВремени.Коэффициент КАК ЧИСЛО(31, 8))
	...
	|			И ОсновныеЗаписи.БазовыйПериодКонец = БазовыеЗаписи.БазовыйПериодОсновнойЗаписиКонец
	|			И (БазовыеВидыРасчета.ВидРасчета = БазовыеЗаписи.ВидРасчета)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТКоэффициентыБазовыхЗаписейУдержанийПоВремени КАК КоэффициентыБазовыхЗаписейУдержанийПоВремени
	|		ПО (БазовыеЗаписи.Регистратор = КоэффициентыБазовыхЗаписейУдержанийПоВремени.Регистратор)
	|			И (БазовыеЗаписи.НомерСтроки = КоэффициентыБазовыхЗаписейУдержанийПоВремени.НомерСтроки)
	|			И (БазовыеЗаписи.НеобходимоНормировать)
	|			И (НЕ БазовыеЗаписи.НормироватьКаскадно)
	|			И (НЕ КоэффициентыБазовыхЗаписейУдержанийПоВремени.ВедущаяЗаписьКаскадногоРасчета)
	|			И (КоэффициентыБазовыхЗаписейУдержанийПоВремени.БазовыйПериодОсновнойЗаписиНачало = БазовыеЗаписи.БазовыйПериодОсновнойЗаписиНачало)
	|			И (КоэффициентыБазовыхЗаписейУдержанийПоВремени.БазовыйПериодОсновнойЗаписиКонец = БазовыеЗаписи.БазовыйПериодОсновнойЗаписиКонец)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТКоэффициентыКаскадноНормируемыхЗаписей КАК КоэффициентыКаскадноНормируемыхЗаписей
	|		ПО (БазовыеЗаписи.Регистратор = КоэффициентыКаскадноНормируемыхЗаписей.Регистратор)
	|			И (БазовыеЗаписи.НомерСтроки = КоэффициентыКаскадноНормируемыхЗаписей.НомерСтроки)
	|			И (БазовыеЗаписи.НеобходимоНормировать)
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВТОсновныеЗаписи", ОписаниеРасчитываемогоНабораУдержаний.ИмяВТРассчитываемыеЗаписи);
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "ВТРасчетнаяБазаНачислений", ИмяВТРезультат);
