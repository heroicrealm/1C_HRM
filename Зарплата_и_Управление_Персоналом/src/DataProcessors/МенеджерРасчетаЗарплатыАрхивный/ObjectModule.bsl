...
Функция РезультатРасчетаНДФЛ()
	...
	УстановитьПривилегированныйРежим(Истина);
	НДФЛ = УчетНДФЛАрхивныеАлгоритмы.РассчитатьНалогПоОсновнойСтавке(
		ИсключаемыйРегистратор, 
		Организация, 
		МесяцНачисления, 
		МенеджерВременныхТаблиц, , , , 
...
//
Функция ИсчисленныйНалогФизическихЛицПоРезультатамРасчета(РезультатыРасчетов, ИмяКолонкиНалогаИсчисленного = "НалогПоСтавке13", ИмяКолонкиАвансаЗачтенного = "ЗачтеноАвансовыхПлатежейПоСтавке13")
...
Процедура РассчитатьКорректировкиВыплаты()
	...
	ИсчисленныйНалог = ИсчисленныйНалогФизическихЛицПоРезультатамРасчета(НДФЛ);
