...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ЗначениеЗаполнено(УчетнаяЗаписьДокументообора) Тогда
		Отказ = Истина;
	Иначе
	...
	Если НЕ ЗначениеЗаполнено(УчетнаяЗаписьОблачнойПодписи) Тогда
		Отказ = Истина;
	Иначе
		НастройкиПользователя = СервисКриптографииDSSСлужебный.ПолучитьНастройкиПользователя(УчетнаяЗаписьОблачнойПодписи);
		НастроеноПодтверждение = СервисКриптографииDSSКлиентСервер.СвойствоВыполняемойОперации(НастройкиПользователя, "ПодписьДокумента").Подтверждать
				ИЛИ СервисКриптографииDSSКлиентСервер.СвойствоВыполняемойОперации(НастройкиПользователя, "ПодписьПакета").Подтверждать;
	КонецЕсли;
