...
Процедура ИзменитьОформлениеЭПВОблаке(Форма)
	...
	Элементы.ГруппаВОблакеВертикальная.Доступность = Форма.РежимРаботыСКлючами = 1 И НЕ Форма.ТолькоПросмотр И Форма.ДоступнаПодписьМоделиСервиса;
	Элементы.ГруппаВОблакеВыбор.Доступность = Форма.РежимРаботыСКлючами = 1 И НЕ Форма.ТолькоПросмотр И Форма.ДоступнаПодписьМоделиСервиса;
