...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ТабДок <> Неопределено Тогда
...
Процедура НастроитьВидимостьЭлементов(РедактированиеТаблицы)
	...
	Иначе
		Элементы.ГруппаОтображение.ТекущаяСтраница = Элементы.ГруппаОтображение;
...
Процедура ПодготовитьФормуВопроса()
	...
	ИначеЕсли ЗначениеЗаполнено(ТекстВопроса) Тогда
