...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СсылкаОрганизации = ОбщегоНазначенияБЗК.ЗначениеСвойства(Параметры, "Организация");
	Страхователь = СЭДОФСС.СтраховательОрганизации(СсылкаОрганизации, ДатаОкончания);
