...
Процедура ЗаполнитьФормуНаСервере(АдресСведенийОбНДФЛ)
	...
	ДанныеПрошлыхПериодов = УчетНДФЛ.ДанныеОДоходахНалогахВычетах(Сотрудники, Год(МесяцРасчета), Организация, , ДатаАктуальности, , Истина, "ЗарегистрированоПриНачисленииАванса < ДАТАВРЕМЯ(" + Сред(Формат(МесяцРасчета,"ДЛФ=D"), 7) + ", " + Месяц(МесяцРасчета) + ", 1, 0, 0, 0)");
