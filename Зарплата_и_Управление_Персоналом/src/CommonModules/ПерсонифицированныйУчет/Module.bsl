...
Процедура ОпределитьСвойстваОбъектовДляОтображенииВФормеОтчетность(СвойстваОбъектов) Экспорт
	...
	ТипыАнкетПерУчета.Добавить(Тип("ДокументСсылка.ПачкаДокументовДСВ_1"));
	...
	Если СоответствиеСсылокСвойствам.Количество() = 0 Тогда
		Возврат
	КонецЕсли;
	
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = Новый МенеджерВременныхТаблиц;
	УчетСтраховыхВзносов.ВременнаяТаблицаОтчитывающихсяПоВзносамОрганизаций(Запрос.МенеджерВременныхТаблиц, ДокументыПерсУчета, "ОтчетныйПериод");
	УчетСтраховыхВзносов.ВременнаяТаблицаОтчитывающихсяПоВзносамОрганизаций(Запрос.МенеджерВременныхТаблиц, АнкетыПерУчета, , "ВТОтчитывающиесяОрганизацииАнкет");
	...
	Если ДокументыПерсУчета.Количество() > 0 Тогда
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, СведенияОЗастрахованныхЛицахСЗВ_М.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, СведенияОЗастрахованныхЛицахСЗВ_М.Организация.КодОрганаПФР),
		...
		|		ПО СведенияОЗастрахованныхЛицахСЗВ_М.Организация = ОтчитывающиесяОрганизации.Организация
		|			И СведенияОЗастрахованныхЛицахСЗВ_М.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, СведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, СведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
		|		ПО СведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ.Организация = ОтчитывающиесяОрганизации.Организация
		|			И СведенияОСтраховомСтажеЗастрахованныхЛицСЗВ_СТАЖ.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, ДанныеОКорректировкеСведенийЗастрахованныхЛицСЗВ_КОРР.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, ДанныеОКорректировкеСведенийЗастрахованныхЛицСЗВ_КОРР.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
		|		ПО ДанныеОКорректировкеСведенийЗастрахованныхЛицСЗВ_КОРР.Организация = ОтчитывающиесяОрганизации.Организация
		|			И ДанныеОКорректировкеСведенийЗастрахованныхЛицСЗВ_КОРР.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
		|		ПО СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ.Организация = ОтчитывающиесяОрганизации.Организация
		|			И СведенияОЗаработкеСтажеЗастрахованныхЛицСЗВ_ИСХ.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
		|		ПО ОписьОДВ_1.Организация = ОтчитывающиесяОрганизации.Организация
		|			И ОписьОДВ_1.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	РеестрДСВ_3.Ссылка,
		|	РеестрДСВ_3.Дата,
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, РеестрДСВ_3.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, РеестрДСВ_3.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
		|		ПО РеестрДСВ_3.Организация = ОтчитывающиесяОрганизации.Организация
		|			И РеестрДСВ_3.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, СведенияОТрудовойДеятельностиРаботниковСЗВ_ТД.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, СведенияОТрудовойДеятельностиРаботниковСЗВ_ТД.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
		|		ПО СведенияОТрудовойДеятельностиРаботниковСЗВ_ТД.Организация = ОтчитывающиесяОрганизации.Организация
		|			И СведенияОТрудовойДеятельностиРаботниковСЗВ_ТД.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
	...
	Если АнкетыПерУчета.Количество() > 0 Тогда 
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, ПачкаДокументовАДВ_1.Организация) КАК Организация,
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, ПачкаДокументовАДВ_1.Организация.КодОрганаПФР) КАК КодКонтролирующегоОргана,
		|	ПачкаДокументовАДВ_1.ПометкаУдаления КАК ПометкаУдаления,
		|	НАЧАЛОПЕРИОДА(ПачкаДокументовАДВ_1.Дата, ДЕНЬ) КАК ДатаНачала,
		|	КОНЕЦПЕРИОДА(ПачкаДокументовАДВ_1.Дата, ДЕНЬ) КАК ДатаОкончания,
		|	ПачкаДокументовАДВ_1.Комментарий КАК Комментарий,
		|	""-"" КАК ВариантОтчета
		|ИЗ
		|	Документ.ПачкаДокументовАДВ_1 КАК ПачкаДокументовАДВ_1
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизацииАнкет КАК ОтчитывающиесяОрганизации
		|		ПО ПачкаДокументовАДВ_1.Организация = ОтчитывающиесяОрганизации.Организация
		|			И ПачкаДокументовАДВ_1.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, ПачкаДокументовАДВ_2.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, ПачкаДокументовАДВ_2.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизацииАнкет КАК ОтчитывающиесяОрганизации
		|		ПО ПачкаДокументовАДВ_2.Организация = ОтчитывающиесяОрганизации.Организация
		|			И ПачкаДокументовАДВ_2.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, ПачкаДокументовАДВ_3.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, ПачкаДокументовАДВ_3.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизацииАнкет КАК ОтчитывающиесяОрганизации
		|		ПО ПачкаДокументовАДВ_3.Организация = ОтчитывающиесяОрганизации.Организация
		|			И ПачкаДокументовАДВ_3.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
		...
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, ПачкаДокументовСЗВ_К.Организация),
		|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация.КодОрганаПФР, ПачкаДокументовСЗВ_К.Организация.КодОрганаПФР),
		...
		|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизацииАнкет КАК ОтчитывающиесяОрганизации
		|		ПО ПачкаДокументовСЗВ_К.Организация = ОтчитывающиесяОрганизации.Организация
		|			И ПачкаДокументовСЗВ_К.Ссылка = ОтчитывающиесяОрганизации.Документ
		|ГДЕ
...
Процедура СоздатьВТСведенияОбОрганизацияхПоОписаниюДокументаИсточникаДанных(МенеджерВременныхТаблиц, ОписаниеИсточникаДанных, ИспользоватьОрганизациюДокумента = Истина) Экспорт
	
	Запрос = Новый Запрос;
	Запрос.МенеджерВременныхТаблиц = МенеджерВременныхТаблиц;
	Запрос.УстановитьПараметр("СписокСсылок", ОписаниеИсточникаДанных.СписокСсылок);
	
	Если ИспользоватьОрганизациюДокумента Тогда
		Запрос.Текст = 
		"ВЫБРАТЬ ПЕРВЫЕ 0
		|	НЕОПРЕДЕЛЕНО КАК Документ,
		|	ЗНАЧЕНИЕ(Справочник.Организации.ПустаяСсылка) КАК Организация,
		|	ЗНАЧЕНИЕ(Справочник.Организации.ПустаяСсылка) КАК ОтчитывающаясяПоВзносамОрганизация
		|ПОМЕСТИТЬ ВТОтчитывающиесяОрганизации";
		Запрос.Выполнить();
	Иначе
		УчетСтраховыхВзносов.ВременнаяТаблицаОтчитывающихсяПоВзносамОрганизаций(МенеджерВременныхТаблиц, ОписаниеИсточникаДанных.СписокСсылок, ОписаниеИсточникаДанных.ИмяПоляПериод);
	КонецЕсли;
	УдаляемыеТаблицы = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве("ВТОтчитывающиесяОрганизации");
	
	ТекстЗапроса = 
	"ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	ИсточникДанных.Организация КАК ОрганизацияДокумента,
	|	ЕСТЬNULL(ОтчитывающиесяОрганизации.ОтчитывающаясяПоВзносамОрганизация, ИсточникДанных.Организация) КАК Организация,
	|	ИсточникДанных.Период КАК Период
	|ПОМЕСТИТЬ ВТОрганизации
	|ИЗ
	|	#ИсточникДанных КАК ИсточникДанных
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТОтчитывающиесяОрганизации КАК ОтчитывающиесяОрганизации
	|		ПО ИсточникДанных.Организация = ОтчитывающиесяОрганизации.Организация
	|			И ИсточникДанных.Ссылка = ОтчитывающиесяОрганизации.Документ
	|ГДЕ
	|	ИсточникДанных.Ссылка В(&СписокСсылок)";
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "ИсточникДанных.Организация", "ИсточникДанных." + ОписаниеИсточникаДанных.ИмяПоляОрганизация);
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, ".Период", "." + ОписаниеИсточникаДанных.ИмяПоляПериод); 
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "#ИсточникДанных", ОписаниеИсточникаДанных.ИмяТаблицы); 
	Запрос.Текст = ТекстЗапроса;
	Запрос.Выполнить();
	УдаляемыеТаблицы.Добавить("ВТОрганизации");
...
Процедура СоздатьВТСведенияОбОрганизацияхПоВременнойТаблице(МенеджерВременныхТаблиц) Экспорт
	...
	|	ДанныеОрганизации.РайонныйКоэффициент КАК РайонныйКоэффициент,
	|	ДанныеОрганизации.ГоловнаяОрганизация КАК ГоловнаяОрганизация
	...
	Колонки = МенеджерВременныхТаблиц.Таблицы["ВТОрганизации"].Колонки;
	Если Колонки.Найти("ОрганизацияДокумента") = Неопределено Тогда
		ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "Организации.ОрганизацияДокумента", "Организации.Организация")
	КонецЕсли;
	Запрос.Текст = ТекстЗапроса;
...
Процедура СоздатьВТЗаписиСтажаПоДаннымУчета2014(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ПараметрыПолученияДанных, ПараметрыОтбора, ОкончаниеПериода = Неопределено)
	...
	Если Не ЗначениеЗаполнено(Организация) Тогда
		...
		|	ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0) КАК ДатаНачалаПериода,
		|	ДАТАВРЕМЯ(1, 1, 1, 0, 0, 0) КАК ДатаОкончанияПериода,
		|	НЕОПРЕДЕЛЕНО КАК ТипДоговора,
		...
		|	ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.ПустаяСсылка) КАК ТерриториальныеУсловияДополнительные,
		|	ЛОЖЬ КАК ФиксСтаж,
		|	ЛОЖЬ КАК ПрерываниеСтажа,
		|	ЛОЖЬ КАК СложныйСтаж
...
Функция СоздатьВТДанныеСтажаПФРИзВТЗаписиСтажа(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод, ОкончаниеПериода, ИмяВТИсточникаДанных, ПараметрыОтбора)
	...
	|	ТаблицаСтажа.ТерриториальныеУсловияДополнительные,
	...
	|	СтажПоМесяцам.ТерриториальныеУсловияДополнительные,
...
Функция ДокументыСЗВПравилаПроверкиДанныхЗЛ(ПроверятьАдрес) Экспорт 
	...
	ПравилоПроверкиФамилия.ОбязательноКЗаполнению = Ложь;
	...
	ПравилоПроверкиИмя.ОбязательноКЗаполнению = Ложь;
...
Функция ПараметрыИсчисляемогоСтажаПредусматривающиеПравоНаДосрочнуюПенсию() Экспорт
	...
	МассивПараметров.Добавить(Справочники.ПараметрыИсчисляемогоСтраховогоСтажа.КВАЛИФ);
...
Процедура ЗаполнитьИмяИЗаголовокФайла(УзелПФР, ДеревоФормата, ИмяФайла) Экспорт	
	...
	НаборЗаписейПрограммаПодготовкиДанных.Версия = Лев(ВРег(РегламентированнаяОтчетность.ВерсияПрограммы()), 10);
...
Процедура ЗаполнитьАдрес(НаборЗаписейАдрес, СтрокаАдрес, СписокСтран, ФорматНеструктурированныйАдрес, ФорматИностранныйАдрес, ЗаменятьБуквуЕ = Ложь) Экспорт
	СведенияОбАдресе = РаботаСАдресами.СведенияОбАдресе(СтрокаАдрес);
	
	Если СведенияОбАдресе.Свойство("Индекс") Тогда
		ЗаПределамиРФ = Ложь;
	Иначе
	...
	Если ЗаПределамиРФ Тогда
		Если СведенияОбАдресе.Страна = "РОССИЯ" Тогда
			// Неструктурированный адрес
			НаборЗаписейАдрес = ОбщегоНазначения.СкопироватьРекурсивно(ФорматНеструктурированныйАдрес);
			НаборЗаписейАдрес.НеструктурированныйАдрес.Значение.Адрес = ВРег(СокрЛП(СведенияОбАдресе.Представление));
		...
		Иначе
			...
			НазваниеСтраны = ВРег(СокрЛП(СведенияОбАдресе.Страна));
			...
			Иначе
				...
				НаборЗаписейАдрес.ИностранныйАдрес.Значение.Адрес = ВРег(СокрЛП(СведенияОбАдресе.Представление));
		...
		КонецЕсли;
	Иначе
		ИменаПолей = "Индекс, Регион, РегионТипКраткий, Район, РайонТипКраткий, Город, ГородТипКраткий, НаселенныйПункт, НаселенныйПунктТипКраткий, Улица, УлицаТипКраткий, Дом, Корпус, Квартира";
		АдресСписком = КонтактнаяИнформацияБЗК.СвернутьСведенияОбАдресе(СведенияОбАдресе, ИменаПолей);
		
		Если ЗаменятьБуквуЕ Тогда
			ЗаменитьБуквуЁ(АдресСписком.Регион);
			ЗаменитьБуквуЁ(АдресСписком.Район);
			ЗаменитьБуквуЁ(АдресСписком.Город);
			ЗаменитьБуквуЁ(АдресСписком.НаселенныйПункт);
			ЗаменитьБуквуЁ(АдресСписком.Улица);
		КонецЕсли;
		...
		НаборЗаписейРоссийскийАдрес.Регион.Значение.ГеографическоеНазвание = ВРег(СокрЛП(АдресСписком.Регион));
		НаборЗаписейРоссийскийАдрес.Регион.Значение.Сокращение             = ВРег(СокрЛП(АдресСписком.РегионТипКраткий));
		
		НаборЗаписейРоссийскийАдрес.Район.Значение.ГеографическоеНазвание = ВРег(СокрЛП(АдресСписком.Район));
		НаборЗаписейРоссийскийАдрес.Район.Значение.Сокращение             = ВРег(СокрЛП(АдресСписком.РайонТипКраткий));
		
		НаборЗаписейРоссийскийАдрес.Город.Значение.ГеографическоеНазвание = ВРег(СокрЛП(АдресСписком.Город));
		НаборЗаписейРоссийскийАдрес.Город.Значение.Сокращение             = ВРег(СокрЛП(АдресСписком.ГородТипКраткий));
		
		НаборЗаписейРоссийскийАдрес.НаселенныйПункт.Значение.ГеографическоеНазвание = ВРег(СокрЛП(АдресСписком.НаселенныйПункт));
		НаборЗаписейРоссийскийАдрес.НаселенныйПункт.Значение.Сокращение             = ВРег(СокрЛП(АдресСписком.НаселенныйПунктТипКраткий));
		
		НаборЗаписейРоссийскийАдрес.Улица.Значение.ГеографическоеНазвание = ВРег(СокрЛП(АдресСписком.Улица));
		НаборЗаписейРоссийскийАдрес.Улица.Значение.Сокращение             = ВРег(СокрЛП(АдресСписком.УлицаТипКраткий));
...
Функция ЗапросПоШапкеДляПечатиОДВ_1(МассивСсылок, ИмяДокумента) Экспорт 
	...
	СоздатьВТСведенияОбОрганизацияхПоОписаниюДокументаИсточникаДанных(Запрос.МенеджерВременныхТаблиц, ОписаниеИсточникаДанных, Ложь);
	...
	|	ВЫБОР
	|		КОГДА ПОДСТРОКА(ЕСТЬNULL(ВТФИОПоследние.Фамилия, """"), 1, 10) = ""-""
	|			ТОГДА """"
	|		ИНАЧЕ ЕСТЬNULL(ВТФИОПоследние.Фамилия, """")
...
Функция ЗапросПоДаннымДосрочногоНазначенияПенсииОДВ_1(МассивСсылок, ИмяДокумента) Экспорт 
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ВЫБОР
	               |		КОГДА ДосрочноеНазначениеПенсии.Подразделение.НаименованиеДляЗаписейОТрудовойДеятельности = """"
	               |			ТОГДА ДосрочноеНазначениеПенсии.Подразделение.Наименование
	               |		ИНАЧЕ ДосрочноеНазначениеПенсии.Подразделение.НаименованиеДляЗаписейОТрудовойДеятельности
	               |	КОНЕЦ КАК НаименованиеПодразделения,
	               |	ДосрочноеНазначениеПенсии.Должность КАК Должность,
	               |	ВЫБОР
	               |		КОГДА ДосрочноеНазначениеПенсии.Должность.НаименованиеДляЗаписейОТрудовойДеятельности = """"
	               |			ТОГДА ДосрочноеНазначениеПенсии.Должность.Наименование
	               |		ИНАЧЕ ДосрочноеНазначениеПенсии.Должность.НаименованиеДляЗаписейОТрудовойДеятельности
...
Процедура УстановитьПараметрыВыбораКатегорииЗастрахованногоЛица(Элементы, ИмяЭлемента, ОтчетныйПериод) Экспорт 
	
	Категории = КатегорииЗастрахованныхЛиц(ОтчетныйПериод);
	
	ПараметрыВыбора = Новый Массив;
	ПараметрыВыбора.Добавить(Новый ПараметрВыбора("Отбор.Ссылка", Новый ФиксированныйМассив(Категории)));
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы,
		ИмяЭлемента, "ПараметрыВыбора", Новый ФиксированныйМассив(ПараметрыВыбора));

КонецПроцедуры

Функция КатегорииЗастрахованныхЛиц(ОтчетныйПериод) 
	
	Категории = Новый ТаблицаЗначений;
	Категории.Колонки.Добавить("Категория", Новый ОписаниеТипов("ПеречислениеСсылка.КатегорииЗастрахованныхЛицДляПФР"));
	Категории.Колонки.Добавить("Начало", Новый ОписаниеТипов("Дата"));
	Категории.Колонки.Добавить("Окончание", Новый ОписаниеТипов("Дата"));
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.НР;
	НоваяСтрока.Начало = '19960101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.СХ;
	НоваяСтрока.Начало = '19960101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ОЗОИ;
	НоваяСтрока.Начало = '20100101';
	НоваяСтрока.Окончание = '20101231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ЕСХН;
	НоваяСтрока.Начало = '20100101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ХМН;
	НоваяСтрока.Начало = '20110101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ХО;
	НоваяСтрока.Начало = '20110101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ТВЭЗ;
	НоваяСтрока.Начало = '20110101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ОДИТ;
	НоваяСтрока.Начало = '20100101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.СМИ;
	НоваяСтрока.Начало = '20110101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ПНЭД;
	НоваяСтрока.Начало = '20110101';
	НоваяСтрока.Окончание = '20181231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ИЦС;
	НоваяСтрока.Начало = '20100101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ООИ;
	НоваяСтрока.Начало = '20110101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖНР;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПНР;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖСХ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПСХ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖЕН;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПЕН;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.УСЕН;
	НоваяСтрока.Начало = '20100101';
	НоваяСтрока.Окончание = '20101231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖМН;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПМН;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖОИ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПОИ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖХО;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПХО;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖТЗ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПТЗ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖИТ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПИТ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖСИ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПСИ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20141231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖЭД;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20181231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПЭД;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20181231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖЦС;
	НоваяСтрока.Начало = '20100101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПЦС;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.АСБ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖСБ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПСБ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ЧЭС;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖЭС;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПЭС;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ИНЖУ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20131231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖИЖ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20131231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПИЖ;
	НоваяСтрока.Начало = '20120101';
	НоваяСтрока.Окончание = '20131231';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.КРС;
	НоваяСтрока.Начало = '20150101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ТОР;
	НоваяСтрока.Начало = '20150101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖКС;
	НоваяСтрока.Начало = '20150101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖТР;
	НоваяСтрока.Начало = '20150101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПКС;
	НоваяСтрока.Начало = '20150101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПТР;
	НоваяСтрока.Начало = '20150101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.СПВЛ;
	НоваяСтрока.Начало = '20160101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖВЛ;
	НоваяСтрока.Начало = '20160101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПВЛ;
	НоваяСтрока.Начало = '20160101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.АНМ;
	НоваяСтрока.Начало = '20180101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПАН;
	НоваяСтрока.Начало = '20180101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖАН;
	НоваяСтрока.Начало = '20180101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.КЛН;
	НоваяСтрока.Начало = '20180101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖКЛ;
	НоваяСтрока.Начало = '20180101';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.МС;
	НоваяСтрока.Начало = '20200401';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖМС;
	НоваяСтрока.Начало = '20200401';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПМС;
	НоваяСтрока.Начало = '20200401';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.КВ;
	НоваяСтрока.Начало = '20200401';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВЖКВ;
	НоваяСтрока.Начало = '20200401';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.ВПКВ;
	НоваяСтрока.Начало = '20200401';
	НоваяСтрока.Окончание = '00010101';
	
	НоваяСтрока = Категории.Добавить();
	НоваяСтрока.Категория = Перечисления.КатегорииЗастрахованныхЛицДляПФР.НРОВ;
	НоваяСтрока.Начало = '20010101';
	НоваяСтрока.Окончание = '20011231';
	
	СписокКатегорий = Новый Массив;
	Для Каждого ДанныеКатегории Из Категории Цикл
		Если ОтчетныйПериод >= ДанныеКатегории.Начало
			И (Не ЗначениеЗаполнено(ДанныеКатегории.Окончание) Или ДанныеКатегории.Окончание >= ОтчетныйПериод) Тогда
			СписокКатегорий.Добавить(ДанныеКатегории.Категория);
		КонецЕсли;
	КонецЦикла;
...
Процедура ПроверитьДанныеСтрокиСотрудника(ДанныеСотрудника, УникальныеИНН, УникальныеСтраховыеНомера, Отказ, ИмяПоляИНН = "НомерСтроки", Ошибки = Неопределено) Экспорт 
	...
	ПроверитьФИОСотрудника(ДанныеСотрудника, Отказ, ИмяПоляИНН, Ошибки);
	
КонецПроцедуры

Процедура ПроверитьФИОСотрудника(ДанныеСотрудника, Отказ, ИмяПоляСотрудник = "Сотрудник", Ошибки = Неопределено) Экспорт 
	
	Если Не ЗначениеЗаполнено(ДанныеСотрудника.Фамилия) И Не ЗначениеЗаполнено(ДанныеСотрудника.Имя) Тогда
		ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Строка %1: у сотрудника должна быть заполнена фамилия или имя.'"),
			ДанныеСотрудника.НомерСтроки);
		ОбщегоНазначенияБЗК.ДобавитьОшибкуЗаполненияДокумента(Ошибки, ТекстСообщения, ,
			"Объект.Сотрудники[" + Формат(ДанныеСотрудника.НомерСтроки - 1, "ЧН=0; ЧГ=0") + "]." + ИмяПоляСотрудник, , Отказ);
	КонецЕсли;
...
Процедура СоздатьВТДанныеСтажаСотрудников(МенеджерВременныхТаблиц, Организация, ОтчетныйПериод) Экспорт 
	...
	Запрос.УстановитьПараметр("ПовышениеКвалификации", Справочники.ПараметрыИсчисляемогоСтраховогоСтажа.КВАЛИФ);
	...
	КадровыеДанные = "ФизическоеЛицо,ЯвляетсяРаботникомСДосрочнойПенсией";
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ВЫБОР
	               |		КОГДА ДанныеСтажаПФР.ТретийПараметрИсчисляемогоСтажа = &ПовышениеКвалификации
	               |			ТОГДА ЗНАЧЕНИЕ(Справочник.ТерриториальныеУсловияПФР.ПустаяСсылка)
	               |		ИНАЧЕ ДанныеСтажаПФР.ТерриториальныеУсловия
...
Функция ПечатнаяФормаСЗВМПоДаннымДокументов(ОбъектыПечати, ВыборкаПоШапкеДокумента, ВыборкаПоРаботникиОрганизации, РазбиватьПоСотрудникам = Ложь, ПараметрыПечати = Неопределено) Экспорт
	
	Макет2016 = УправлениеПечатью.МакетПечатнойФормы("ОбщийМакет.ФормаСЗВ_М");
	Макет2021 = УправлениеПечатью.МакетПечатнойФормы("ОбщийМакет.ФормаСЗВ_М_2021");
	ДокументРезультат = Новый ТабличныйДокумент;
	...
	Пока ВыборкаПоШапкеДокумента.Следующий() Цикл
		...
		Пока ВыборкаПоРаботникиОрганизации.Следующий() Цикл
			...
			Если РазбиватьПоСотрудникам Тогда
				...
				КадровыйЭДО.ЗадатьДетальнуюОбластьПечати(ПараметрыПечати, ДокументРезультат, ИдентификаторПечатнойФормыФормаСВЗМ(), НачалоБланка,
					ВыборкаПоРаботникиОрганизации, ВыборкаПоШапкеДокумента.Ссылка);
...
Функция ИдентификаторПечатнойФормыФормаСВЗМ() Экспорт
	Возврат "ФормаСВЗ_М";
КонецФункции
...
Функция ПечатнаяФормаСЗВСТАЖПоДаннымДокументов(ОбъектыПечати, ВыборкаПоШапкеДокумента, ВыборкаПоРаботникам, РазбиватьПоСотрудникам = Ложь, ПараметрыПечати = Неопределено) Экспорт
	...
	Пока ВыборкаПоШапкеДокумента.СледующийПоЗначениюПоля("Ссылка") Цикл 
		...
		Если РазбиватьПоСотрудникам Тогда
			...
			ЗаполнитьЗначенияСвойств(ОбластьПодпись.Параметры, ВыборкаПоШапкеДокумента);
		КонецЕсли;
			...
			Пока ВыборкаПоРаботникам.СледующийПоЗначениюПоля("НомерСтроки") Цикл
				...
				Если ВыборкаПоРаботникам.ЗаполненСтаж Тогда
					Пока ВыборкаПоРаботникам.СледующийПоЗначениюПоля("НомерОсновнойЗаписи") Цикл
						...
						КонецЕсли;
						ВывестиСтрокуСтажа(ВыборкаПоРаботникам, ОбластьСтрокаСтажа, ВыборкаПоШапкеДокумента, ДокументРезультат, ТекущийЛист, Макет, НомерСтраницы, ОбластьЗаголовок, ОбластьПодпись);
				...
				Если РазбиватьПоСотрудникам Тогда
					...
					Если Не ТекущийЛист.ПроверитьВывод(ОбластьПодвал) Тогда 
						ТекущийЛист.Вывести(ОбластьПодпись);
					КонецЕсли;
				...
				КадровыйЭДО.ЗадатьДетальнуюОбластьПечати(ПараметрыПечати, ДокументРезультат, ИдентификаторПечатнойФормыФормаСЗВСТАЖ(), НачалоБланка,
					ВыборкаПоРаботникам, ВыборкаПоШапкеДокумента.Ссылка);
...
Функция ИдентификаторПечатнойФормыФормаСЗВСТАЖ() Экспорт
	Возврат "ПФ_MXL_ФормаСЗВ_СТАЖ";
КонецФункции

Процедура ВывестиСтрокуСтажа(ВыборкаПоРаботникам, ОбластьСтрокаСтажа, ВыборкаПоШапкеДокумента, ДокументРезультат, ТекущийЛист, Макет, НомерСтраницы, ОбластьЗаголовок, ОбластьПодпись)
	...
	ВывестиОбласть(ОбластьСтрокаСтажа, ВыборкаПоШапкеДокумента, ДокументРезультат, ТекущийЛист, Макет, НомерСтраницы, ОбластьЗаголовок, ОбластьПодпись);
	
КонецПроцедуры

Процедура ВывестиОбласть(ВыводимаяОбласть, ВыборкаПоШапкеДокумента, ДокументРезультат, ТекущийЛист, Макет, НомерСтраницы, ОбластьЗаголовок = Неопределено, ОбластьПодпись = Неопределено)
	
	ВыводимыеОбласти = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(ВыводимаяОбласть);
	Если ОбластьПодпись <> Неопределено Тогда 
		ВыводимыеОбласти.Добавить(ОбластьПодпись);
	КонецЕсли;
	Если ТекущийЛист.ПроверитьВывод(ВыводимыеОбласти) Тогда 
		ТекущийЛист.Вывести(ВыводимаяОбласть);
	Иначе
	...
	Пока Выборка.СледующийПоЗначениюПоля("Сотрудник") Цикл 
		...
		Пока Выборка.Следующий() Цикл
			...
			Если ПериодыСлужбы = Неопределено И ЗначениеЗаполнено(Выборка.ТретийПараметрИсчисляемогоСтажа) И ЗначениеЗаполнено(Выборка.ЗамещениеГосударственныхМуниципальныхДолжностей) Тогда 
				...
				ДобавитьСтрокуЗаписейОСтаже(ТаблицаОтклонений, Выборка, ДатыВыходаНаПенсию, ПериодыСлужбы, ДатаПостановления322);
				Продолжить;
			КонецЕсли;
			...
			КонецЕсли;
			Если Выборка.ОснованиеИсчисляемогоСтажа = Справочники.ОснованияИсчисляемогоСтраховогоСтажа.ВИРУС
				И Выборка.ДатаНачалаПериода >= ДатаПрекращенияДействияКодаВИРУС() Тогда
				ДанныеЗаписи.ОснованиеИсчисляемогоСтажа = Справочники.ОснованияИсчисляемогоСтраховогоСтажа.ПустаяСсылка();
			КонецЕсли;
			...
			КонецЕсли;
			ВывестиСтрокиОтклонений(ЗаписиОСтаже, ТаблицаОтклонений, ПредыдущаяСтрока);
			ДобавитьСтрокуЗаписейОСтаже(ЗаписиОСтаже, Выборка, ДатыВыходаНаПенсию, ПериодыСлужбы, ДатаПостановления322);
		КонецЦикла;
		ВывестиСтрокиОтклонений(ЗаписиОСтаже, ТаблицаОтклонений, ПредыдущаяСтрока);
...
Процедура ДобавитьСтрокуЗаписейОСтаже(ДанныеОСтаже, Выборка, ДатыВыходаНаПенсию, ПериодыСлужбы, ДатаПостановления322)
	...
	Если ПериодыСлужбы <> Неопределено Тогда 
		НоваяСтрока.ЗамещениеГосударственныхМуниципальныхДолжностей = Справочники.ОснованияИсчисляемогоСтраховогоСтажа.ПустаяСсылка();
	КонецЕсли;
	
	ПрекращениеДействияКодаВИРУС = ДатаПрекращенияДействияКодаВИРУС();
	Если Выборка.ОснованиеИсчисляемогоСтажа = Справочники.ОснованияИсчисляемогоСтраховогоСтажа.ВИРУС
		И Выборка.ДатаОкончанияПериода >= ПрекращениеДействияКодаВИРУС Тогда
		Если Выборка.ДатаНачалаПериода >= ПрекращениеДействияКодаВИРУС Тогда
			НоваяСтрока.ОснованиеИсчисляемогоСтажа = Справочники.ОснованияИсчисляемогоСтраховогоСтажа.ПустаяСсылка();
		Иначе
			ОбработатьТерриториальныеУсловияДополнительные(Выборка, ДанныеОСтаже);
			СтрокаСтажа = ДанныеОСтаже.Добавить();
			ЗаполнитьЗначенияСвойств(СтрокаСтажа, НоваяСтрока);
			СтрокаСтажа.ОснованиеИсчисляемогоСтажа = Неопределено;
			СтрокаСтажа.ДатаНачалаПериода = ПрекращениеДействияКодаВИРУС;
			НоваяСтрока.ДатаОкончанияПериода = ПрекращениеДействияКодаВИРУС - 86400;
		КонецЕсли;
	КонецЕсли;
	
	ОбработатьТерриториальныеУсловияДополнительные(Выборка, ДанныеОСтаже);
	ОбработатьПериодПовышенияКвалификации(ДанныеОСтаже, НоваяСтрока, ДатаПостановления322)
...
Процедура ОбработатьТерриториальныеУсловияДополнительные(Выборка, ДанныеОСтаже)
...
// Постановление Правительства РФ от 04.03.2021 № 322
Процедура ОбработатьПериодПовышенияКвалификации(ДанныеОСтаже, СтрокаСтажа, ДатаПостановления322) Экспорт 
	
	Если СтрокаСтажа.ТретийПараметрИсчисляемогоСтажа <> Справочники.ПараметрыИсчисляемогоСтраховогоСтажа.КВАЛИФ Тогда 
		Возврат;
	КонецЕсли;
	
	Если СтрокаСтажа.ДатаНачалаПериода >= ДатаПостановления322 Тогда
		Возврат;
	КонецЕсли;
	
	ЛьготныйСтаж = Новый Структура(
		"ОснованиеВыслугиЛет,
		|ОсобыеУсловияТруда,
		|КодПозицииСписка,
	...
	Если СтрокаСтажа.ДатаОкончанияПериода >= ДатаПостановления322 Тогда
		НоваяСтрока = ДанныеОСтаже.Добавить();
		ЗаполнитьЗначенияСвойств(НоваяСтрока, СтрокаСтажа);
		НоваяСтрока.ДатаНачалаПериода = ДатаПостановления322;
		СтрокаСтажа.ДатаОкончанияПериода = ДатаПостановления322 - 86400;
	КонецЕсли;
	
	ЗаполнитьЗначенияСвойств(СтрокаСтажа, ЛьготныйСтаж);
	
КонецПроцедуры

Функция ДатаПрекращенияДействияКодаВИРУС()
