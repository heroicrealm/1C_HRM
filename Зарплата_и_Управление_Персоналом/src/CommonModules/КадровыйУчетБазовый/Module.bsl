...
Процедура ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек) Экспорт
	...
	Настройка.ИдентификаторПечатнойФормы = Метаданные.ОбщиеМакеты.ПФ_MXL_ТрудовойДоговорМикропредприятий.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.ОбщиеМакеты.ПФ_MXL_Т1.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.ОбщиеМакеты.ПФ_MXL_Т5.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
...
Функция ЗапросВТКадровыеДанныеСотрудников(ТолькоРазрешенные, ОписательВременнойТаблицыОтборов, КадровыеДанные, ПоляОтбораПериодическихДанных, ФормироватьСПериодичностьДень, ИсточникиДанных, ИмяВТКадровыеДанныеСотрудников, ТаблицаОтборовСодержитПолеФизическоеЛицо, УничтожитьВспомогательныеТаблицы) Экспорт
	...
	Для каждого ИмяЗапрашиваемыхДанных Из ИменаКадровыхДанных Цикл
		...
		ИначеЕсли ДобавитьПолеСведенийКадровойИсторииСотрудников(ИмяКадровыхДанных, ТекстыОписанияПолей, ИсточникиДанных)
			...
			Или КадровыйУчет.ДобавитьПолеСведнийМестРаботыСотрудников(ИмяКадровыхДанных, ТекстыОписанияПолей, ИсточникиДанных) Тогда
...
Функция ДобавитьПолеСведнийМестРаботыСотрудников(ИмяПоля, ТекстыОписанияПолей, ИсточникиДанных) Экспорт
