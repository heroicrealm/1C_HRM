...
Процедура ПриВременнойРегистрацииИсправления(Движения, ДанныеДляПроведения) Экспорт
	...
	Если ПараметрыСторнирования.ИсправлениеВТекущемПериоде И Не ПараметрыСторнирования.ИсправлениеДоначислением Тогда
...
Процедура ЗаполнитьКакФиксСторно(СтрокаСторно, Строка)
...
//
Функция НеобходимоДоначислятьЗарплату(ИсправляемыйДокумент, НачисленияИсправляемогоДокумента, НачисленияТекущегоДокумента)
...
Функция ПолучитьРаспределениеНачислений(ПоказателиЗатронутыхНачислений, ПоказателиНачисленийЗаднимЧислом, ИсключаемыйРегистратор)
