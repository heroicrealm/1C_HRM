...
Процедура ПриОткрытии(Форма, Отказ) Экспорт 
	...
	Если Форма.Элементы.ДеревоСтраниц.Видимость = Истина Тогда 
...
Процедура ЗагрузитьИзФайлаУведомлениеПослеУстановкиРасширения(ДополнительныеПараметры) Экспорт
...
Процедура ЗагрузитьИзФайлаУведомление(Форма) Экспорт
	...
	Иначе
		...
		Исключение
		КонецПопытки;
		ОО = Новый ОписаниеОповещения("ЗагрузитьИзФайлаУведомлениеПослеУстановкиРасширения", ЭтотОбъект, ДополнительныеПараметры);
		НачатьУстановкуРасширенияРаботыСФайлами(ОО);
	КонецЕсли;
КонецПроцедуры
