...
Функция ПредставлениеКонтролирующегоОргана(ЗначенияЗаполнения) Экспорт
	...
	Если ЗначениеЗаполнено(ЗначенияЗаполнения.ВидКонтролирующегоОргана) Тогда
		...
		ИначеЕсли ЗначенияЗаполнения.ВидКонтролирующегоОргана = Перечисления.ТипыКонтролирующихОрганов.РегистрацияЮЛФНС Тогда
			ПредставлениеКонтролирующегоОргана = "Регистрация ЮЛ в ФНС" + КодКонтролирующегоОргана;
		Иначе
...
Процедура УведомлениеОСпецрежимахНалогообложения_ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка) Экспорт 
	...
	Если Параметры.Свойство("Ключ") И ЗначениеЗаполнено(Параметры.Ключ) Тогда
		...
		УведомлениеОСпецрежимахНалогообложения.ЗаменитьИмяОтчетаПередОткрытием(Параметры.Ключ, ВидСообщения, ИмяФормы, ИмяОтчета);
	Иначе
