...
Функция ЗначениеXML(ЗначениеXML, ТипВозвращаемогоЗначения) Экспорт
	...
	Если ТипЗначенияXML = Тип("ЭлементDOM") Тогда
		Возврат ЗначениеXML(ЗначениеXML.ТекстовоеСодержимое, ТипВозвращаемогоЗначения);
...
Функция СтроковыйРеквизитОбъекта(ОбъектXDTO, ПутьКСвойству) Экспорт
	Возврат ЗначениеXMLТипаСтрока(ОбщегоНазначенияБЗК.ЗначениеСвойства(ОбъектXDTO, ПутьКСвойству));
КонецФункции
