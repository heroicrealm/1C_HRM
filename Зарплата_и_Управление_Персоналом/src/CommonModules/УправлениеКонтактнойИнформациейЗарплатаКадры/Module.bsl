...
// Устарела. Следует использовать УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъектов.
//   См. также интерфейс модуля КонтактнаяИнформацияБЗК 
//   и функцию УправлениеКонтактнойИнформацией.ПредставлениеКонтактнойИнформацииОбъекта.
...
// Устарела. Следует использовать КонтактнаяИнформацияБЗК.НайтиКонтактнуюИнформацию.
//   См. также интерфейс модуля КонтактнаяИнформацияБЗК.
