...
//
Функция РезультатРасчетаЗаймов(Организация, ДатаОкончания, Документ, Сотрудники = Неопределено, Подразделение = Неопределено, РассчитыватьМатериальнуюВыгоду = Истина) Экспорт
...
Процедура ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек) Экспорт
	...
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Документы.ОтменаСовмещения.Макеты.ПФ_MXL_ПриказОбОтменеСовмещения.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.НеСодержитЗарплаты;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Документы.Совмещение.Макеты.ПФ_MXL_ДополнительноеСоглашение.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Документы.Совмещение.Макеты.ПФ_MXL_ПриказНаСовмещение.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Обработки.ПечатьКадровыхПриказовРасширенная.Макеты.ПФ_MXL_ПриказОВыходеНаНеполноеРабочееВремя.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.НеСодержитЗарплаты;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Обработки.ПечатьКадровыхПриказовРасширенная.Макеты.ПФ_MXL_ПриказОВыходеНаРаботуИзОтпускаПоУходуЗаРебенком.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.НеСодержитЗарплаты;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Обработки.ПечатьКадровыхПриказовРасширенная.Макеты.ПФ_MXL_ПриказОПрекращенииОтпускаПоУходуЗаРебенком.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.НеСодержитЗарплаты;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Отчеты.ПечатнаяФормаТ11.Макеты.ПФ_MXL_Т11.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
	Настройка.БлокировкаСУсловием = Истина;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Обработки.ПечатьКадровыхПриказовРасширенная.Макеты.ПФ_MXL_ПриказОВыплатеМатериальнойПомощи.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитТарифныеСтавки;
	Настройка.БлокировкаСУсловием = Истина;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Обработки.ПечатьКадровыхПриказовРасширенная.Макеты.ПФ_MXL_ПриказОбОплатеПоСреднемуЗаработку.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.НеСодержитЗарплаты;
	Настройка.БлокировкаСУсловием = Истина;
