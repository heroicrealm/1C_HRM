...
//     * ИмяФормыОтчета - Строка - имя формы отчета "6-НДФЛ (с 2021 года)", например, "ФормаОтчета2021Кв4"
...
//     * ИмяФормыОтчета - Строка - имя формы отчета "Расчет по страховым взносам", например, "ФормаОтчета2022Кв1"
//                        (необязательное свойство; если отсутствует, значение будет получено автоматически).
//
// Возвращаемое значение:
//  Массив - массив структур с данными отчетов (пустой массив, если отчетов не найдено).
