	...
	Если Выборка.Количество() > 0 Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Иначе
				...
				ПозицияОбъект.НаименованиеПолное = ?(СтрДлина(НаименованиеПозиции) > 150, НаименованиеПозиции, "");
...
Процедура ОбновитьШтатноеРасписаниеПоДаннымДокумента(Организация, ДатаВступленияВСилу, Позиции, ЕжегодныеОтпуска, СтрокиСНовымиПозициями, СведенияОНаименованиях)
	...
	Для каждого СтрокаПозиции Из Позиции Цикл
		...
		Иначе
			...
			ПозицияШтатногоРасписанияОбъект.Наименование = НаименованиеПозиции;
			ПозицияШтатногоРасписанияОбъект.НаименованиеПолное = ?(СтрДлина(НаименованиеПозиции) > 150, НаименованиеПозиции, "");
