...
Процедура ОписаниеПоказателей_РСВ_2022Кв1(ПоказателиОтчета) Экспорт
	...
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М102001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М103001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М104001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М105001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М106001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М107001", Истина, Ложь);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М108001", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М108002", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М108003", Истина, Истина);
	ЗарплатаКадры.ДобавитьПоказательРегламентированнойОтчетности(ПоказателиОтчета, "П00016М108004", Истина, Истина);
...
Процедура ЗначенияПоказателей_РСВ_2022Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	ОписаниеПоказателей_РСВ_2022Кв1(ПоказателиОтчета);
	...
	Раздел1Прил6 = Контейнер.Раздел1Прил6.Строки[0].ДанныеМногострочныхЧастей.П00016М1.Строки;
	СтруктураПолейПрил6 = ОбщегоНазначения.СкопироватьРекурсивно(Раздел1Прил6[0].Данные);
	Раздел1Прил6.Очистить();
	ОчиститьПоляСтруктурыПоказателей(ПоказателиОтчета, СтруктураПолейПрил6);
	...
	Если ПараметрыОтчета.Свойство("ФормированиеПерсонифицированныхСведенийОЗастрахованныхЛицах") Тогда
		...
		КлючиСтруктурыОписанийТаблиц = "ДоходыВРазрезеТарифов2022,ВзносыВРазрезеТарифов2022,ВсеТарифы2022,Подраздел3Физлица2022,Подраздел321Доходы2022,Подраздел322Доходы2022";
	Иначе
		КлючиСтруктурыОписанийТаблиц = "ЧисленностьВРазрезеТарифов2022,ДоходыВРазрезеТарифов2022,ВзносыВРазрезеТарифов2022,ВсеТарифы2022,Подраздел31Доходы2022,Подраздел31Численность2022,Подраздел31Взносы2022,Подраздел32Основания2022,Подраздел32Численность2022,Подраздел32Доходы2022,Подраздел32Взносы2022,ЧисленностьЗастрахованныхВРазрезеТарифов2022,Иностранцы,Подраздел3Физлица2022,Подраздел321Доходы2022,Подраздел322Доходы2022,Приложение11Доходы2022,Приложение11Численность2022,Приложение11Взносы2022,ДоходыФСС2022,РасходыФСС2022";
	КонецЕсли;
	ОписаниеТаблиц = Новый Структура(КлючиСтруктурыОписанийТаблиц);
	ОписаниеТаблиц.Вставить("НомерКорректировки", НомерКорректировки);	
	РасчетПоказателей_РСВ_2022(НачалоПериода, ОкончаниеПериода, ОрганизацииДляСбораДанных, ОписаниеТаблиц, Ложь, ДатаАктуальности, МассивФизическихЛиц);
	
	// Проверяем собранные данные
	
	ВсеТарифы = ОписаниеТаблиц.ВсеТарифы2022;
	ТаблицаДоходов = ОписаниеТаблиц.ДоходыВРазрезеТарифов2022;
	ТаблицаВзносов = ОписаниеТаблиц.ВзносыВРазрезеТарифов2022;
	ВсеФизлица = ОписаниеТаблиц.Подраздел3Физлица2022;
	...
	Если ТарифыСПроблемамиУчета.Количество() > 0 Или ФизлицаСПроблемамиУчета.Количество() > 0 Тогда
		...
		НоваяСтрока = Раздел1Прил6.Добавить();
		НоваяСтрока.Данные = ОбщегоНазначения.СкопироватьРекурсивно(СтруктураПолейПрил6);
		НоваяСтрока.ДанныеМногострочныхЧастей = Новый Структура();
	...
	Если Не ПараметрыОтчета.Свойство("ФормированиеПерсонифицированныхСведенийОЗастрахованныхЛицах") Тогда
		...
		Если ОписаниеТаблиц.ЧисленностьЗастрахованныхВРазрезеТарифов2022.Количество() > 0 Тогда
			КоличествоЗастрахованных = ОписаниеТаблиц.ЧисленностьЗастрахованныхВРазрезеТарифов2022[0];
		КонецЕсли;
		
		ТаблицаВсегоЗастрахованных = ОписаниеТаблиц.ЧисленностьЗастрахованныхВРазрезеТарифов2022;
		ТаблицаКоличеств = ОписаниеТаблиц.ЧисленностьВРазрезеТарифов2022;
		ТаблицаДоходовБезСпецОценки = ОписаниеТаблиц.Подраздел31Доходы2022;
		ТаблицаКоличествБезСпецОценки = ОписаниеТаблиц.Подраздел31Численность2022;
		ТаблицаВзносовБезСпецОценки = ОписаниеТаблиц.Подраздел31Взносы2022;
		ВсеОснованияСпецОценки = ОписаниеТаблиц.Подраздел32Основания2022;
		ТаблицаДоходовСоСпецОценкой = ОписаниеТаблиц.Подраздел32Доходы2022;
		ТаблицаКоличествСоСпецОценкой = ОписаниеТаблиц.Подраздел32Численность2022;
		ТаблицаВзносовСоСпецОценкой = ОписаниеТаблиц.Подраздел32Взносы2022;
		ТаблицаПриложения2 = ОписаниеТаблиц.ДоходыФСС2022;
		Для каждого СтрокаРезультата Из ВсеТарифы Цикл
		...
		Если Раздел1Прил1.Количество() = 0 Тогда
			...
			СтрокаПрил2.Данные = ОбщегоНазначения.СкопироватьРекурсивно(СтруктураПолейПрил2);
			СтрокаПрил2.Данные.П00012М100101 = "01";
			ЗаполнитьЗначенияСвойств(СтрокаПрил2.Данные, КоличествоЗастрахованных);
			СтрокаПрил2.ДанныеМногострочныхЧастей = Новый Структура();
		КонецЕсли;
		
		// Приложение 2, расходы
		ТаблицаПриложения2Расходы = ОписаниеТаблиц.РасходыФСС2022;
		...
		// Приложение 1.1 
		ТаблицаДоходовАвиаторовГорняков = ОписаниеТаблиц.Приложение11Доходы2022;
		ТаблицаКоличествАвиаторовГорняков = ОписаниеТаблиц.Приложение11Численность2022;
		ТаблицаВзносовАвиаторовГорняков = ОписаниеТаблиц.Приложение11Взносы2022;
	...
	// Раздел 3
	Если ВсеФизлица.Количество() > 0 Тогда
		ТаблицаДоходовФизлиц = ОписаниеТаблиц.Подраздел321Доходы2022;
		ТаблицаВредныхДоходовФизлиц = ОписаниеТаблиц.Подраздел322Доходы2022;
		...
		Для каждого СтрокаРезультата Из ВсеФизлица Цикл
			...
			Если СтрокаРезультата.ФизическоеЛицо <> Неопределено И СтрокаРезультата.П000030001001 <> "1" Тогда
				...
				Для каждого СтрокаДанных Из СтрокиДоходов Цикл
					...
					ИначеЕсли ЗначениеЗаполнено(СтрокаРезультата.НачалоРаботы) Тогда
						СтрокаДохода.Данные.П00321М113001 = ОбщегоНазначения.ИмяЗначенияПеречисления(СтрокаРезультата.КатегорияЗастрахованныхЛиц);
					Иначе
				...
				Если НоваяСтрока.ДанныеМногострочныхЧастей.П00321М1.Строки.Количество() = 0 Тогда
					СтрокаДохода = НоваяСтрока.ДанныеМногострочныхЧастей.П00321М1.Строки.Добавить();
					СтрокаДохода.Данные = ОбщегоНазначения.СкопироватьРекурсивно(СтруктураПолейПодраздел321);
					Если ЗначениеЗаполнено(СтрокаРезультата.НачалоРаботы) Тогда
						ОстатокОтДеления = Месяц(СтрокаРезультата.НачалоРаботы) % 3;
						СтрокаДохода.Данные.П00321М112001 = Строка(?(ОстатокОтДеления = 0, 3, ОстатокОтДеления));
						...
						КонецЕсли;
						СтрокаДохода.Данные.П00321М113001 = ОбщегоНазначения.ИмяЗначенияПеречисления(КатегорияНулевыхДоходов);
					КонецЕсли;
				КонецЕсли;
...
Процедура ЗначенияПоказателей_РСВ_2021(ПараметрыОтчета, Контейнер)
	...
	ОписаниеТаблиц = Новый Структура(КлючиСтруктурыОписанийТаблиц);
	ОписаниеТаблиц.Вставить("НомерКорректировки", НомерКорректировки);	
	РасчетПоказателей_РСВ_2021(НачалоПериода, ОкончаниеПериода, ОрганизацииДляСбораДанных, ОписаниеТаблиц, Ложь, ДатаАктуальности, МассивФизическихЛиц);
...
Процедура ЗначенияПоказателей_РСВ_2020Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	Если ПараметрыОтчета.ДатаКонцаПериодаОтчета >= '20210101' Тогда
		ЗначенияПоказателей_РСВ_2021(ПараметрыОтчета, Контейнер);
		Возврат
	КонецЕсли;
...
Процедура РасчетПоказателейРСВ(ИмяРасчета, НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные = Ложь, ДатаАктуальности = Неопределено, МассивФизическихЛиц = Неопределено) Экспорт
	...
	Если ИмяРасчета = "РасчетПоказателей_РСВ_2022Кв1" Тогда
		РасчетПоказателей_РСВ_2022(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, УточненнаяДатаАктуальности, МассивФизическихЛиц);
	ИначеЕсли ИмяРасчета = "РасчетПоказателей_РСВ_2020Кв1" Тогда
		Если НачалоПериода >= '20210101' Тогда
			РасчетПоказателей_РСВ_2021(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, УточненнаяДатаАктуальности, МассивФизическихЛиц);
		Иначе
			РасчетПоказателей_РСВ_2020(НачалоПериода, ОкончаниеПериода, ОтчитывающаясяОрганизация, ОписаниеТаблиц, ПодробныеДанные, УточненнаяДатаАктуальности, МассивФизическихЛиц);
		КонецЕсли;
	ИначеЕсли ИмяРасчета = "РасчетПоказателей_РСВ_2017Кв1" Тогда
		РасчетПоказателей_РСВ_2018(НачалоПериода, ОкончаниеПериода, ОтчитывающаясяОрганизация, ОписаниеТаблиц, ПодробныеДанные, УточненнаяДатаАктуальности, МассивФизическихЛиц);
	Иначе
...
Процедура РасчетПоказателей_РСВ_2022(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц)
	...
	Если ОписаниеТаблиц.Свойство("ЧисленностьЗастрахованныхВРазрезеТарифов2022") Или ОписаниеТаблиц.Свойство("Подраздел3Физлица2022") Или ОписаниеТаблиц.Свойство("ДоходыФСС2022") Тогда
	...
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("ЧисленностьЗастрахованныхВРазрезеТарифов2022") Или ОписаниеТаблиц.Свойство("ВсеТарифы2022") 
		Или ОписаниеТаблиц.Свойство("ДоходыВРазрезеТарифов2022") Или ОписаниеТаблиц.Свойство("ЧисленностьВРазрезеТарифов2022") 
		Или ОписаниеТаблиц.Свойство("ВзносыВРазрезеТарифов2022") Или ОписаниеТаблиц.Свойство("Подраздел321Доходы2022") 
		Или ОписаниеТаблиц.Свойство("ДоходыФСС2022") Тогда
	...
	Если ОписаниеТаблиц.Свойство("ЧисленностьЗастрахованныхВРазрезеТарифов2022") Тогда 
		...
		|ГДЕ
		|	ЗастрахованныеЛица.ВидТарифаСтраховыхВзносов = ЗНАЧЕНИЕ(Справочник.ВидыТарифовСтраховыхВзносов.ДляСубъектовМалогоПредпринимательства)";
		...
		ОписаниеТаблиц.ЧисленностьЗастрахованныхВРазрезеТарифов2022 = Запрос.Выполнить().Выгрузить()
		
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("ВсеТарифы2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	Доходы.КодТарифа,
		|	Доходы.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов
		...
		|УПОРЯДОЧИТЬ ПО
		|	Доходы.КодТарифа";
		ОписаниеТаблиц.ВсеТарифы2022 = Запрос.Выполнить().Выгрузить();
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("ДоходыВРазрезеТарифов2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		|	СведенияОДоходах.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов,
		...
		ОписаниеТаблиц.ДоходыВРазрезеТарифов2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("ЧисленностьВРазрезеТарифов2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
		|	Доходы.Период,
		|	Доходы.ФизическоеЛицо,
		...
		|СГРУППИРОВАТЬ ПО
		|	Тарифы.ВидТарифаСтраховыхВзносов";
		ОписаниеТаблиц.ЧисленностьВРазрезеТарифов2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("ВзносыВРазрезеТарифов2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		...
		ОписаниеТаблиц.ВзносыВРазрезеТарифов2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	
	// Подраздел 3.1 Приложения 1 Раздела 1
	
	Если ОписаниеТаблиц.Свойство("Подраздел31Доходы2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		|	ВЫБОР
		...
		Иначе 
			...
			Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей);
		КонецЕсли;
		ОписаниеТаблиц.Подраздел31Доходы2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Подраздел31Численность2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
		...
		|СГРУППИРОВАТЬ ПО
		|	ЛицаСТяжелымиВзносамиЗаВсеМесяцы.ВидТарифаСтраховыхВзносов";
		ОписаниеТаблиц.Подраздел31Численность2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Подраздел31Взносы2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		|	ВЫБОР
		...
		Иначе 
			...
			Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей, "ВзносыФизлиц");
		КонецЕсли;
		ОписаниеТаблиц.Подраздел31Взносы2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	
	// Подраздел 3.2 Приложения 1 Раздела 1
	
	Если ОписаниеТаблиц.Свойство("Подраздел32Основания2022") Или ОписаниеТаблиц.Свойство("Подраздел32Доходы2022") Или ОписаниеТаблиц.Свойство("Подраздел322Доходы2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
		|	СведенияОДоходах.Период КАК Период,
		|	ВЫБОР
		...
		Запрос.Выполнить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Подраздел32Основания2022") Или ОписаниеТаблиц.Свойство("Подраздел32Численность2022") Или ОписаниеТаблиц.Свойство("Подраздел32Взносы2022") Или ОписаниеТаблиц.Свойство("Подраздел322Доходы2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
	...
	Если ОписаниеТаблиц.Свойство("Подраздел32Основания2022") Тогда
		// АПК:96-выкл Использование ОБЪЕДИНИТЬ оправдано
		Запрос.Текст =
		"ВЫБРАТЬ РАЗЛИЧНЫЕ
		|	Доходы.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов,
		...
		|	П11132М100201";
		// АПК:96-вкл 
		ОписаниеТаблиц.Подраздел32Основания2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Подраздел32Доходы2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		|	СведенияОДоходах.ВидТарифаСтраховыхВзносов КАК ВидТарифаСтраховыхВзносов,
		...
		Иначе 
			...
			Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей);
		КонецЕсли;
		ОписаниеТаблиц.Подраздел32Доходы2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Подраздел32Численность2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
		...
		ОписаниеТаблиц.Подраздел32Численность2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Подраздел32Взносы2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		|	ВзносыФизлиц.ВидТарифаСтраховыхВзносов,
		...
		Иначе 
			...
			Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей, "ВзносыФизлиц");
		КонецЕсли;
		ОписаниеТаблиц.Подраздел32Взносы2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	
	// Приложения 1.1 Раздела 1
	
	Если ОписаниеТаблиц.Свойство("Приложение11Доходы2022") Или ОписаниеТаблиц.Свойство("Приложение11Численность2022") Или ОписаниеТаблиц.Свойство("Приложение11Взносы2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
		|	СведенияОДоходах.Период КАК Период,
		|	""1"" КАК Основание,
		...
		Запрос.Выполнить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Приложение11Доходы2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		...
		Иначе 
			...
			Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей);
		КонецЕсли;
		ОписаниеТаблиц.Приложение11Доходы2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Приложение11Численность2022") Тогда
		Запрос.Текст =
		"ВЫБРАТЬ
		|	ВзносыФизлиц.Основание КАК Основание,
		|	СУММА(ВЫБОР
		...
		|СГРУППИРОВАТЬ ПО
		|	ОснованияВзносов.Основание";
		ОписаниеТаблиц.Приложение11Численность2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("Приложение11Взносы2022") Тогда
		ТекстЗапроса =
		"ВЫБРАТЬ
		...
		Иначе 
			...
			Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей, "ВзносыФизлиц");
		КонецЕсли;
		ОписаниеТаблиц.Приложение11Взносы2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	
	// Приложение 2 Раздела 1 
	Если ОписаниеТаблиц.Свойство("ДоходыФСС2022") Тогда
		...
		КонецЕсли;
		Запрос.Текст = УдалитьПоляРасшифровкиИзЗапроса(ТекстЗапроса, МассивПолей);
		ОписаниеТаблиц.ДоходыФСС2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	Если ОписаниеТаблиц.Свойство("РасходыФСС2022") Тогда
		
		Запрос.Текст = 
		"ВЫБРАТЬ
		|	ЕСТЬNULL(СУММА(РасчетыСФСС.ПолученоИзФонда), 0) КАК П000120007001,
		|	ЕСТЬNULL(СУММА(ВЫБОР
		...
		|		И Расчеты.Организация В(&ОбособленноеПодразделение)
		...
		ОписаниеТаблиц.РасходыФСС2022 = Запрос.Выполнить().Выгрузить()
	КонецЕсли;
	
	// Физлица и их кадровые данные
	Если ОписаниеТаблиц.Свойство("Подраздел3Физлица2022") Или ОписаниеТаблиц.Свойство("Иностранцы") Тогда
	...
	Если ОписаниеТаблиц.Свойство("Иностранцы") Тогда
		...
		Если Не ОписаниеТаблиц.Свойство("ДоходыФСС2022") И Не ОписаниеТаблиц.Свойство("ЧисленностьЗастрахованныхВРазрезеТарифов2022") И Не ОписаниеТаблиц.Свойство("Подраздел3Физлица2022") Тогда
			Запрос.Текст =
			"ВЫБРАТЬ
			|	СведенияОДоходах.ФизическоеЛицо КАК ФизическоеЛицо,
			|	СведенияОДоходах.Период КАК Период,
		...
		Иначе
			...
			|	ЕСТЬNULL(ФИОФизлиц.Фамилия, """") КАК П00016М102001,
			|	ЕСТЬNULL(ФИОФизлиц.Имя, """") КАК П00016М103001,
			|	ЕСТЬNULL(ФИОФизлиц.Отчество, """") КАК П00016М104001,
			|	ЕСТЬNULL(ФИОФизлиц.ИНН, """") КАК П00016М105001,
			|	ЕСТЬNULL(ФИОФизлиц.СтраховойНомерПФР, """") КАК П00016М106001,
			|	ЕСТЬNULL(ФИОФизлиц.Страна.Код, ""999"") КАК П00016М107001,
			|	ЕСТЬNULL(СУММА(СведенияОДоходах.Начислено), 0) КАК П00016М108001,
			|	ЕСТЬNULL(СУММА(ВЫБОР
			|				КОГДА МЕСЯЦ(СведенияОДоходах.Период) = &Месяц1
			|					ТОГДА СведенияОДоходах.Начислено
			|				ИНАЧЕ 0
			|			КОНЕЦ), 0) КАК П00016М108002,
			|	ЕСТЬNULL(СУММА(ВЫБОР
			|				КОГДА МЕСЯЦ(СведенияОДоходах.Период) = &Месяц2
			|					ТОГДА СведенияОДоходах.Начислено
			|				ИНАЧЕ 0
			|			КОНЕЦ), 0) КАК П00016М108003,
			|	ЕСТЬNULL(СУММА(ВЫБОР
			|				КОГДА МЕСЯЦ(СведенияОДоходах.Период) = &Месяц3
			|					ТОГДА СведенияОДоходах.Начислено
			|				ИНАЧЕ 0
			|			КОНЕЦ), 0) КАК П00016М108004
			|ИЗ
	...
	// Раздел 3
	Если ОписаниеТаблиц.Свойство("Подраздел3Физлица2022") Или ОписаниеТаблиц.Свойство("Подраздел321Доходы2022") Или ОписаниеТаблиц.Свойство("Подраздел322Доходы2022") Тогда
		
		Если ОписаниеТаблиц.Свойство("НомерКорректировки") И ЗначениеЗаполнено(ОписаниеТаблиц.НомерКорректировки) Тогда
			ПолучитьПереданныеДанныеОтчета2021(ОтчитывающаясяОрганизация, ОкончаниеПериода, Запрос.МенеджерВременныхТаблиц, ОписаниеТаблиц.НомерКорректировки, "ФормаОтчета2022Кв1");
		Иначе
		...
		Если ОписаниеТаблиц.Свойство("Подраздел3Физлица2022") Тогда
			Запрос.Текст = 
			"ВЫБРАТЬ
			...
			|	ФИО,
			|	П000030001001 УБЫВ";
			ОписаниеТаблиц.Подраздел3Физлица2022 = Запрос.Выполнить().Выгрузить();
		КонецЕсли;

		Если ОписаниеТаблиц.Свойство("Подраздел321Доходы2022") Тогда
			Запрос.Текст = 
			"ВЫБРАТЬ
			|	СведенияОДоходах.ФизическоеЛицо,
			...
			|	СведенияОДоходах.П00321М112001,
			|	СведенияОДоходах.П00321М113001";
			ОписаниеТаблиц.Подраздел321Доходы2022 = Запрос.Выполнить().Выгрузить();
		КонецЕсли;

		Если ОписаниеТаблиц.Свойство("Подраздел322Доходы2022") Тогда
			Запрос.Текст = 
			"ВЫБРАТЬ
			|	Данные.ФизическоеЛицо,
			|	Данные.П00322М118001,
			...
			|	Данные.П00322М118001,
			|	Данные.П00322М119001";
			ОписаниеТаблиц.Подраздел322Доходы2022 = Запрос.Выполнить().Выгрузить();
		КонецЕсли;
...
Процедура РасчетПоказателей_РСВ_2021(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц)
	...
	Если ОписаниеТаблиц.Свойство("Подраздел3Физлица2020") Или ОписаниеТаблиц.Свойство("Подраздел321Доходы2020") Или ОписаниеТаблиц.Свойство("Подраздел322Доходы2020") Тогда
		...
		Если ОписаниеТаблиц.Свойство("НомерКорректировки") И ЗначениеЗаполнено(ОписаниеТаблиц.НомерКорректировки) Тогда
			ПолучитьПереданныеДанныеОтчета2021(ОтчитывающаясяОрганизация, ОкончаниеПериода, Запрос.МенеджерВременныхТаблиц, ОписаниеТаблиц.НомерКорректировки, "ФормаОтчета2020Кв4");
		Иначе
			СоздатьПустыеВТПереданныхДанныхОтчета2021(Запрос.МенеджерВременныхТаблиц)
		КонецЕсли;
...
Процедура РасчетПоказателей_РСВ_2020(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц)
	УчетСтраховыхВзносовАрхивныеАлгоритмы.РасчетПоказателей_РСВ_2020(НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные, ДатаАктуальности, МассивФизическихЛиц);
КонецПроцедуры
...
Процедура РасчетПоказателей4ФСС(ИмяРасчета, НачалоПериода, ОкончаниеПериода, Организация, ОписаниеТаблиц, ПодробныеДанные = Ложь) Экспорт
	...
	ИначеЕсли ИмяРасчета = "РасчетПоказателей_4ФСС_2017Кв1" Тогда
		РасчетПоказателей_4ФСС_2017Кв1(НачалоПериода, ОкончаниеПериода, ОтчитывающаясяОрганизация, ОписаниеТаблиц, ПодробныеДанные);
	ИначеЕсли ИмяРасчета = "РасчетПоказателей_4ФСС_2019" Тогда
		...
		Иначе 
			РасчетПоказателей_4ФСС_2019(НачалоПериода, ОкончаниеПериода, ОтчитывающаясяОрганизация, ОписаниеТаблиц, ПодробныеДанные);
		КонецЕсли;
	Иначе
...
Процедура ПолучитьПереданныеДанныеОтчета2021(Организация, ДатаОкончания, МенеджерВременныхТаблиц, НомерКорректировки, ИмяФормы)
