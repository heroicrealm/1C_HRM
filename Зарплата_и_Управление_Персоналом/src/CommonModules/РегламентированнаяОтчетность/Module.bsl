...
Процедура ВставитьПоказатели_Имущество(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2022Кв1"
...
Процедура ВставитьПоказатели_НДПИ(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2021Кв1"
...
Процедура ВставитьПоказатели_Прибыль(ТаблицаПоказателей, ОписаниеОтчета)
	...
	Если ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2021Кв4"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2020Кв4"
		ИЛИ ОписаниеОтчета.ВыбраннаяФорма = "ФормаОтчета2019Кв4" Тогда
...
Процедура ЗапретитьРедактированиеРеквизитовСданногоОтчета(Форма, КонтролирующийОрган = "ФНС") Экспорт
	...
	ЗапретитьРедактированиеПользователем = СтрНачинаетсяС(СтатусОтправки, "Сдано")
		...
		И СтатусОтправки = СтатусОтправкиВЖурнале;
	...
	Если ЗапретитьРедактированиеПользователем Тогда
		Попытка
			...
			// Получение последнего цикла обмена отчета для последующего формирования штампа ЭЦП.
			...
			Если ТекущееСостояние <> Неопределено И ЗначениеЗаполнено(ЦиклОбмена) Тогда
				...
				Если ЭлементПоказатьБланк <> Неопределено Тогда
					...
					Если КомандаПоказатьБланк <> Неопределено Тогда
						ЗаголовокУточнение = "(со штампом ЭЦП)";
...
Процедура РазрешитьРедактированиеРеквизитовОтчета(Форма) Экспорт
	...
	// Удалить ссылку на последний цикл обмена - не будут выводиться в печатных формах штампы ЭЦП.
