...
Процедура ЗаполнитьНастройкиПечатныхФормПоУмолчанию(ОписанияНастроек) Экспорт
	...
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Документы.ДоговорЗаймаСотруднику.Макеты.ПФ_MXL_ГрафикПогашенияЗайма.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитЗарплату;
	
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = Метаданные.Документы.ДоговорЗаймаСотруднику.Макеты.ПФ_MXL_ДоговорЗайма.Имя;
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитЗарплату;
	
	// Печатает макет ПФ_MXL_ГрафикПогашенияЗайма из документа ИзменениеУсловийДоговораЗаймаСотруднику
	Настройка = ОписанияНастроек.Добавить();
	Настройка.ИдентификаторПечатнойФормы = "ПФ_MXL_ДополнительноеСоглашениеКДоговоруЗайма";
	Настройка.СодержимоеДокумента = Перечисления.СодержимоеДокументов.СодержитЗарплату;
