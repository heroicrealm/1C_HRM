	...
	Если ДоступнаПередачаДокументовНаРаботаВРоссии() Тогда
		...
		Если Не Форма.Параметры.Свойство("ПодписаниеПечатныхФорм") Тогда
			...
			Если КомандаФормы = Неопределено Тогда
				...
				КомандаФормы.Заголовок = НСтр("ru = 'Передать на ""Работа в России""'");
				КомандаФормы.Подсказка = НСтр("ru = 'Подписать и передать на портал ""Работа в России""'");
				КомандаФормы.Отображение = ОтображениеКнопки.КартинкаИТекст;
				КомандаФормы.Картинка = БиблиотекаКартинок.ПередатьНаРаботаВРоссии;
