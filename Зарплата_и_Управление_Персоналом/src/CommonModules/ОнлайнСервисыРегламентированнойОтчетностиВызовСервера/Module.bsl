...
Процедура ОбновлениеТаблицыФорматовРосстата(Соединение)
	Попытка
		...
		ЧтениеXML.ОткрытьФайл(ИмяВременногоКлючевогоФайла);
		ЧтениеXML.Прочитать();
		...
		Выборка = РегистрыСведений.РесурсыМеханизмаОнлайнСервисовРО.Выбрать(
			Новый Структура("Тип", Перечисления.ТипыРесурсовМеханизмаОнлайнСервисовРО.ТаблицаВерсийФорматовРосстата));
		...
		Архив.Закрыть();
		СодержимоеФайлаСДанными = ПрочитатьТекстовыйФайл(ИмяФайлаИзАрхива, ОписаниеОшибки, Истина, "utf-8");
