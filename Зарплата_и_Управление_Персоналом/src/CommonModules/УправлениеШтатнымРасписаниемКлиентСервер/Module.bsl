...
Функция НаименованиеПозицииШтатногоРасписания(Подразделение, Должность, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если СтандартнаяОбработка Тогда
		...
		Если ЗначениеЗаполнено(РазрядКатегория) Тогда
			НаименованиеПозиции = Строка(?(ЗначениеЗаполнено(ПолноеНаименованиеДолжности), ПолноеНаименованиеДолжности, Должность)) + ", " + Строка(РазрядКатегория);
		Иначе
			НаименованиеПозиции = Строка(?(ЗначениеЗаполнено(ПолноеНаименованиеДолжности), ПолноеНаименованиеДолжности, Должность));
		КонецЕсли;
		
		Если ЗначениеЗаполнено(Подразделение) Тогда
			НаименованиеПозиции = НаименованиеПозиции + ?(ЗначениеЗаполнено(ПолноеНаименованиеПодразделения), " /" + ПолноеНаименованиеПодразделения + "/", " /" + Строка(Подразделение) + "/");
		КонецЕсли;
