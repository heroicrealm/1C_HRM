...
Функция ВызватьHTTPМетод(ОписаниеСоединения, HTTPЗапрос, Метод, ВидОперации, КонтекстДиагностики = Неопределено) Экспорт
...
Функция ПодробноеПредставлениеОшибкиВыполненияHTTPЗапроса(ОписаниеСоединения, HTTPЗапрос, HTTPОтвет, Метод)
	...
	ПодробноеПредставлениеОшибки = СтрШаблон(ШаблонОшибки,
		...
		ПолныйАдресИнтернетРесурса(ОписаниеСоединения, HTTPЗапрос),
		Метод,
		Ответ);
...
// Возвращаемое значение:
// 	Строка - Описание
Функция ПолныйАдресИнтернетРесурса(ОписаниеСоединения, HTTPЗапрос)
	...
	Если ЗначениеЗаполнено(HTTPЗапрос.АдресРесурса) Тогда
		ПолныйАдрес = ПолныйАдрес + "/" + HTTPЗапрос.АдресРесурса;
	КонецЕсли;
	Возврат ПолныйАдрес;
