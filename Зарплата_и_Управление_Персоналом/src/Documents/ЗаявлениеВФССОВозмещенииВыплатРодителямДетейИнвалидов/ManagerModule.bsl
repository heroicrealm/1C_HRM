...
Функция ПараметрыФиксацииВторичныхДанных() Экспорт
	...
	ФиксируемыеТЧ = Новый Структура("Оплаты", СтрРазделить("ДокументОснование,Сотрудник,Месяц", ",", Ложь));
...
Функция ТабличныйДокументЗаявлениеВФССДополнительныеДниОтпуска(МассивСсылок, ОбъектыПечати)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.Ссылка КАК Ссылка,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.Номер КАК Номер,
	...
	|		КОГДА ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.Дата < &ДатаФорм2021
	|			ТОГДА ""ЗаявлениеВФССДополнительныеДниОтпуска_2017""
	|		ИНАЧЕ ""ЗаявлениеВФССДополнительныеДниОтпуска_2021""
	|	КОНЕЦ КАК ИмяМакета,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.Проведен КАК Проведен,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.Организация КАК Организация,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.НаименованиеТерриториальногоОрганаФСС КАК НаименованиеТерриториальногоОрганаФСС,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.РегистрационныйНомерФСС КАК РегистрационныйНомерФСС,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.ДополнительныйКодФСС КАК ДополнительныйКодФСС,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.КодПодчиненностиФСС КАК КодПодчиненностиФСС,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.Руководитель КАК Руководитель,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.ДолжностьРуководителя КАК ДолжностьРуководителя,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.АдресОрганизации КАК АдресОрганизации,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.НаименованиеБанка КАК НаименованиеБанка,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.НомерЛицевогоСчета КАК НомерЛицевогоСчета,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.КБК КАК КБК,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.НомерСчета КАК НомерСчета,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.БИКБанка КАК БИКБанка,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.СтатусДокумента КАК СтатусДокумента,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.ТелефонСоставителя КАК ТелефонСоставителя,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.АдресЭлектроннойПочтыОрганизации КАК АдресЭлектроннойПочтыОрганизации,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.ЗаявлениеСоставил КАК ЗаявлениеСоставил,
	|	ТЧОплаты.Сотрудник КАК Сотрудник,
	|	ТЧОплаты.Статус КАК Статус,
	|	ТЧОплаты.СреднедневнойЗаработок КАК СреднедневнойЗаработок,
	|	ТЧОплаты.ДокументОснование КАК ДокументОснование,
	|	ТЧОплаты.КоличествоСтраниц КАК КоличествоСтраниц,
	|	ТЧОплаты.СуммаПособия КАК СуммаПособия,
	|	ТЧОплаты.СуммаВзносов КАК СуммаВзносов,
	...
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.ИНН КАК ИНН,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.КПП КАК КПП,
	|	ТЧОплаты.Сотрудник.ФизическоеЛицо.СтраховойНомерПФР КАК СНИЛС,
	|	ЗаявлениеВФССОВозмещенииВыплатРодителямДетейИнвалидов.ДополнительныеСведенияДляПеречисления КАК ДополнительныеСведенияДляПеречисления,
	|	ТЧОплаты.КоличествоДней КАК КоличествоДней,
	|	ТЧОплаты.Месяц КАК Месяц
	|ИЗ
		...
		Пока Выборка.СледующийПоЗначениюПоля("Ссылка") Цикл
			Пока Выборка.Следующий() Цикл
				...
				Если ВыведеноСтрок = 1 Тогда
					...
					КонецЕсли;
					Если Выборка.ИмяМакета = "ЗаявлениеВФССДополнительныеДниОтпуска_2021" Тогда 
...
Процедура ВывестиСтрокуЗаявленияОВозмещении_2021(Макет, Выборка, НомерСтроки)
	...
	Макет.Параметры["Имя" + НомерСтроки]      = Выборка.Имя;
	Макет.Параметры["Отчество" + НомерСтроки] = Выборка.Отчество;
	Макет.Параметры["СНИЛС" + НомерСтроки] = Выборка.СНИЛС;
