...
Процедура РассчитатьКоличествоДнейКомпенсацииУдержанияОтпускаНаСервере(РассчитатьДополнительныеОтпуска = Истина)
	...
	ДокументИсправления = СсылкаНаИсправленныйДокумент;
	Пока ЗначениеЗаполнено(ДокументИсправления) Цикл
		ИсключаемыеРегистраторы.Добавить(ДокументИсправления);
		ДокументИсправления = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументИсправления, "ИсправленныйДокумент");
	КонецЦикла;
