...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, РеквизитыСведений, "ФизическоеЛицо, ГоловнаяОрганизация");
...
Процедура ПриЗаписи(Отказ)
	...
	РегистрыСведений.СведенияОЗастрахованныхЛицахФСС.ПриЗаписиРегистрацииСведений(ЭтотОбъект, РеквизитыСведений());
КонецПроцедуры
...
Функция РеквизитыСведений()
	...
	ТребуемыеРеквизитыСведений = РегистрыСведений.СведенияОЗастрахованныхЛицахФСС.ТребуемыеРеквизитыСведений();
	ТребуемыеРеквизитыСведений = СтрРазделить(ТребуемыеРеквизитыСведений, ", ", Ложь);
	ИменаПолейДляРегистрации = СтрРазделить("Ссылка, ФизическоеЛицо, ГоловнаяОрганизация", ", ", Ложь);
