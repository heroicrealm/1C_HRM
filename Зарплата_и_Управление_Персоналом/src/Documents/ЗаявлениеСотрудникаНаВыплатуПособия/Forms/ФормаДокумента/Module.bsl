...
Процедура НастроитьПолеРебенокЗаКоторымОсуществляетсяУход()
	...
	Если ЭтоУходЗаРебенком И ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
		Элементы.РебенокЗаКоторымОсуществляетсяУход.Видимость = Истина;
	...
	Иначе
		Элементы.РебенокЗаКоторымОсуществляетсяУход.Видимость = Ложь;
	КонецЕсли;
КонецПроцедуры
