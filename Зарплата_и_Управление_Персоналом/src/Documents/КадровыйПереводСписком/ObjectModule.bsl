...
Процедура ПриЗаписи(Отказ)
	...
	ПараметрыБухучета.ИмяТаблицы = "Документ.КадровыйПереводСписком.Сотрудники";
	ПараметрыБухучета.ИмяПоляПериод = "Таблица.ДатаНачала";
	ПараметрыБухучета.ИмяПоляДействуетДо = "Таблица.ДатаОкончания";
	ПараметрыБухучета.ИмяПоляРегистрироватьБухучет = "Таблица.ИзменитьПодразделениеИДолжность";
