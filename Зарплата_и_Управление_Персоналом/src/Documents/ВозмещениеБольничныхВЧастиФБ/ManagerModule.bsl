...
Процедура ВывестиСтрокиВозмещенияБольничныхВЧастиФБ(КонтекстПечати, Выборка, ТаблицаПособий)
	...
	Для Каждого СтрокаТаблицы Из ТаблицаПособий Цикл
		...
		УправлениеПечатьюБЗК.ВывестиСуммуРублейКопеекПоБуквам(Секция, СтрокаТаблицы.СуммаФинансируемаяРаботодателем, "СуммаПособия");
		УправлениеПечатьюБЗК.ВывестиСуммуРублейКопеекПоБуквам(Секция, СтрокаТаблицы.СуммаСверхНорм, "РасходыСверхНорм");
	...
	УправлениеПечатьюБЗК.ВывестиСуммуРублейКопеекПоБуквам(Секция, Итого_СуммаПособия, "Итого_СуммаПособия");
	УправлениеПечатьюБЗК.ВывестиСуммуРублейКопеекПоБуквам(Секция, Итого_РасходыСверхНорм, "Итого_РасходыСверхНорм");
