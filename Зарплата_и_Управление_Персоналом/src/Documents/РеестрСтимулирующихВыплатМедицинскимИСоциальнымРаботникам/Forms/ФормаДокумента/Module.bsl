...
Функция СписокПервичныхДокументов(ИдентификаторСтроки)
	...
	ДанныеОтправленныхРеестров = Документы.РеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам.ДанныеОтправленныхРеестров(Объект.Организация,Объект.ВидПособия,СтрокаСотрудника.Сотрудник,Объект.НачалоПериода,Объект.ОкончаниеПериода,Объект.Ссылка);
...
Процедура ЗаполнитьТаблицуСотрудников()
	...
	Сотрудники = Документы.РеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам.СотрудникиПолучателиСтимулирующихВыплатФСС(Объект.Организация, Объект.НачалоПериода, Объект.ОкончаниеПериода);
...
Процедура ДолжностьПриИзмененииНаСервере(ИдентификаторСтроки)
	...
	Если ЗначениеЗаполнено(СтрокаСотрудника.Должность) Тогда
		...
		СтрокаСотрудника.КатегорияПолучателя = КатегорииДолжностей[СтрокаСотрудника.Должность];
	КонецЕсли;
...
Процедура ОбработкаПодбораНаСервере(ДобавляемыеСотрудники, Автозаполнение = Ложь)
	...
	ДанныеПоСотрудникам = Документы.РеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам.СведенияПоСотрудникамНаСервере(Объект.Организация, Объект.НачалоПериода, Объект.ОкончаниеПериода, ДобавляемыеСотрудники,Автозаполнение);
	СменыРаботСотрудниковСКоронавирусом = Документы.РеестрСтимулирующихВыплатМедицинскимИСоциальнымРаботникам.СменыРаботСотрудниковСКоронавирусом(Объект.Организация, Объект.НачалоПериода,Объект.ОкончаниеПериода, Объект.ВидПособия, ДобавляемыеСотрудники, Объект.ОплатаПраздничныхДней, Объект.Ссылка, Объект.Дата);
