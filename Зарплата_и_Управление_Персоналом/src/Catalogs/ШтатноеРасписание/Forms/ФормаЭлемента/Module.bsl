...
Процедура ПоместитьДанныеОбъектаВФорму(ТекущийОбъект, ЗначениеКопирования = Неопределено)
	...
	Если ИспользоватьИсторию И СуществующаяПозиция Тогда
		...
		Если ВнешниеДанные Тогда
			УправлениеШтатнымРасписаниемФормы.ПрочитатьТекущиеДанныеПозицииШтатногоРасписанияВФормуСправочника(ЭтотОбъект, ТекущийОбъект.Ссылка, Объект.ДатаУтверждения, ВнешниеДанные, ДокументРегистратор);
		Иначе
...
Процедура ПриЗаполненииНаименования()
	...
	Объект.Наименование = НаименованиеПозиции;
	Объект.НаименованиеПолное = ?(СтрДлина(НаименованиеПозиции)>150, НаименованиеПозиции,"");
