...
Функция СформироватьСтруктуруПараметров(ИмяФормы,
	...
	СтрокаСведений =
		"ИННЮЛ, КППЮЛ, ДатаРегистрации, ФИОРук, ФИОБух, АдрЮР, РегистрационныйНомерФСС, НомерСтрахователяФСС, КодПодчиненностиФСС";
	...
	ПараметрыВыгрузки.Вставить("РегНомер",         СокрЛП(?(ЗначениеЗаполнено(СведенияОбОрганизации.НомерСтрахователяФСС),
