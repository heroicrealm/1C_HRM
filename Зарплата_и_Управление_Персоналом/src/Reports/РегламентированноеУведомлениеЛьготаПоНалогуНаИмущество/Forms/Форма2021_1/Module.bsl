...
Процедура ПредставлениеУведомленияВыбор(Элемент, Область, СтандартнаяОбработка)
	...
	ИначеЕсли Область.Имя = "СтруктЕдАкт" Тогда 
		...
		ОткрытьФорму("Отчет.РегламентированноеУведомлениеЛьготаПоНалогуНаИмущество.Форма.ФормаВводаСтруктурнойЕдиницы", ПараметрыВыборСтруктурнойЕдиницы, ЭтотОбъект, , , , ВыборСтруктурнойЕдиницы, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
