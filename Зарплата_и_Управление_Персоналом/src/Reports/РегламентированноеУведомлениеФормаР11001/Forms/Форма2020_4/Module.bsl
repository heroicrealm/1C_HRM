...
Процедура ПредставлениеУведомленияПриИзмененииСодержимогоОбласти(Элемент, Область)
	...
	Если СтрНачинаетсяС(Область.Имя, "Ж01020100_") Тогда 
		Постфикс = Число(СтрЗаменить(Область.Имя, "Ж01020100_", ""));
		МногострочнаяЧастьЖ010201[Постфикс-1].Ж01020100 = Область.Значение;
		Модифицированность = Истина;
	КонецЕсли;
КонецПроцедуры
