...
#Область Проверки
	...
	// проверки Дополнительные
	ПроверкаКС_1_21_доп_2021Кв4();
	ПроверкаКС_1_22_доп_2021Кв4();
	ПроверкаКС_1_23_доп_2021Кв4();
	ПроверкаКС_1_24_доп_2021Кв4();
	ПроверкаКС_1_25_доп_2021Кв4();
...
Процедура ПроверкаКС_1_05_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2 = сумме строк ""Общая сумма дохода"" по соответствующим ставке налога и КБК '") +
		НСтр("ru='Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru='(соотношение применяется к 6-НДФЛ за налоговый период)'"));
...
Процедура ПроверкаКС_1_09_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2 = сумме строк ""Сумма налога исчисленная"" по соответствующим ставке налога и КБК '") +
		НСтр("ru='Приложения № 1 к 6-НДФЛ, представленных по всем налогоплательщикам этим налоговым агентом '") +
		НСтр("ru='(соотношение применяется к 6-НДФЛ за налоговый период)'"));
	Заголовки.Вставить("ШаблонРасшифровки"	, НСтр("ru='%1 = %2, ставка %3, КБК %4'"));
	Заголовки.Вставить("ОписаниеОшибки"		, НСтр("ru='Ошибочная сумма налога'"));
...
Процедура ПроверкаКС_1_10_2021Кв4()
	...
	Заголовки.Вставить("ОписаниеКС"			, 
		...
		НСтр("ru='Раздела 2 = сумме строк ""Сумма налога не удержанная налоговым агентом"" по соответствующим '") +
...
Процедура ПроверкаКС_1_21_доп_2021Кв4()
...
Процедура ПроверкаКС_1_22_доп_2021Кв4()
...
Процедура ПроверкаКС_1_23_доп_2021Кв4()
...
Процедура ПроверкаКС_1_24_доп_2021Кв4()
...
Процедура ПроверкаКС_1_25_доп_2021Кв4()
