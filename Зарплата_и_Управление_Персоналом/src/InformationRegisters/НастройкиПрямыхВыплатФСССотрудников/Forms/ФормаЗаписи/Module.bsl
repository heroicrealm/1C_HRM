...
Процедура ПрочитатьОрганизациюСотрудникаФизическоеЛицо()
	...
	Если Не ЗначениеЗаполнено(Запись.ГоловнаяОрганизация) И ЗначениеЗаполнено(Параметры.Организация) Тогда
		Запись.ГоловнаяОрганизация = ЗарплатаКадры.ГоловнаяОрганизация(Параметры.Организация);
	КонецЕсли;
