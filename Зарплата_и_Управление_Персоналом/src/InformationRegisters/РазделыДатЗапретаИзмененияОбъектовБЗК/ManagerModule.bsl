...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Если Константы.ВерсияДанныхДатЗапретаИзмененияБЗК.Получить() <> Метаданные.Версия Тогда
...
Функция ИсточникиПроверкиДатЗапретаИзменения()
	...
	Попытка
		...
		Если Константы.ВерсияДанныхДатЗапретаИзмененияБЗК.Получить() <> Метаданные.Версия Тогда
			...
			Константы.ВерсияДанныхДатЗапретаИзмененияБЗК.Установить(Метаданные.Версия);
